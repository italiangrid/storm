...
* [Quick deploy on CentOS 7](#quickdeploy)
...
## Upgrade from StoRM v1.11.17 on RHEL6 <a name="upgrading">&nbsp;</a>

In case you're updating a RHEL6 deployment, the services that needs to be updated are:
...
If you are upgrading from StoRM v1.11.16 or earlier versions please follow
[these instructions][upgrade-16] before.
...
The latest certified StoRM package can be found in the StoRM production repository:
...
#### Disk Usage Service <a name="duserviceconfiguration">&nbsp;</a>
...
- [StoRM Backend](#puppetbackend)
- [StoRM Frontend](#puppetfrontend)
- [StoRM WebDAV](#puppetwebdav)
- [StoRM Globus GridFTP server](#puppetgridftp)
...
### StoRM Backend component <a name="puppetbackend">&nbsp;</a>
...
### StoRM Frontend component <a name="puppetfrontend">&nbsp;</a>
...
[upgrade-16]: {{site.baseurl}}/documentation/sysadmin-guide/1.11.17/#upgrading
