...
|STORM\_FRONTEND\_PORT					|StoRM Frontend service port. Optional variable. Default value: **8444**
|STORM\_FRONTEND\_PUBLIC\_HOST			|StoRM Frontend service public host. It's used by StoRM Info Provider to publish the SRM endpoint into the Resource BDII.<br/>Optional variable. Default value: **$STORM\_BACKEND\_HOST**
