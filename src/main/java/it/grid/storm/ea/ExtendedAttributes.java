...
public interface ExtendedAttributes {
	 ...
	 * 
	 * @param fileName
	 *          complete path filename of the file to retrieve the attribute for.
	 * @param attributeName
	 ...
	 * 
	 * @throws ExtendedAttributesException
	 *           if an unrecognized error occurred (exception message is set).
	 */
	String getXAttr(String fileName, String attributeName);

	/**
	 * Sets the value of the extended attribute identified by
	 * <code>fileName</code> and associated with the given file in the filesystem.
	 * 
	 * @param filename
	 *          complete path filename of the file to set the attribute for.
	 * @param attributeName
	...
	/**
	 * Removes the extended attribute identified by <code>attributeName</code> and
	 * associated with the given file in the filesystem.
	 * 
	 * @param filename
	 * @param attributeName
	 * 
	 ...
	 *           if <code>attributeName</code> does not exists.
