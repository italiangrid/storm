...
public class StoRIImpl implements StoRI {
  ...
  public StoRIImpl(VirtualFSInterface vfs, MappingRule winnerRule, String relativeStFN,
      StoRIType type) {
  ...
  public StoRIImpl(VirtualFSInterface vfs, String stfnStr, TLifeTimeInSeconds lifetime,
      StoRIType type) {
