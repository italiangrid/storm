...
public class UserInfoCommand {
  ...
  /**
   * Creates an has map of coupplse <group name,group ID> parsing the "getent group" command output
   *
   * @return
   */
  ...
  /**
   * Extracts from the received string (with at least 3 fields separated by ":" ) the GID value as a
   * long
   *
   * @param line
   * @return
