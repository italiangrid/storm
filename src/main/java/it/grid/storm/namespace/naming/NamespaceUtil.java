...
public class NamespaceUtil {
   ...
   */
  public static MappingRule getWinnerRule(
      String stfnPath,
    ...
    Preconditions.checkNotNull(
        mappingRules, "Unable to get winning rule: invalid null mapping rules");
    Preconditions.checkNotNull(
        vfsApproachable, "Unable to get winning rule: invalid null VFS list");
  ...
  public static MappingRule getWinnerRule(
      TSURL surl, Collection<MappingRule> mappingRules, Collection<VirtualFS> vfsApproachable) {

    return getWinnerRule(surl.sfn().stfn().toString(), mappingRules, vfsApproachable);
  }

  public static VirtualFS getWinnerVFS(
      String absolutePath, Map<String, VirtualFS> vfsListByRootPath) throws NamespaceException {
  ...
  public static String resolveVOName(String filename, Map<String, VirtualFS> vfsListByRootPath)
