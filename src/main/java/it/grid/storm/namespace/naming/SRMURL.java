...
public abstract class SRMURL {
  ...
  /**
   * If this is a normal form SRMURL path contains the file path, it instead is a query form SRMURL
   * path contains the service endpoint
   */
  ...
  public SRMURL(
      Protocol protocol, String hostname, int port, String servicePath, String queryString) {
  ...
  /**
   * Returns true if the hostname of this srmurl is the one specified in configuration file field
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof SRMURL)) return false;
    SRMURL other = (SRMURL) obj;
    if (local != other.local) return false;
    if (localSURL != other.localSURL) return false;
    if (path == null) {
    ...
    if (surlType == null) {
      if (other.surlType != null) return false;
    } else if (!surlType.equals(other.surlType)) return false;
    if (transfProtocol == null) {
      if (other.transfProtocol != null) return false;
    } else if (!transfProtocol.equals(other.transfProtocol)) return false;
    return true;
  }
}
