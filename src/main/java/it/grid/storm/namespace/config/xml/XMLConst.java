...
public interface XMLConst {
	...
	public String FS_SPACE_TOKEN_DESCRIPTION = FILESYSTEM
	...
	public String APP_ANONYMOUS_HTTP_READ = APP_RULE + ".anonymous-http-read";
	// ######### Level-4 #########
	// STORAGE-AREA-AUTHZ
	...
	public String getStorageAreaAuthz(String nameOfFS, SAAuthzType type)
		throws NamespaceException; // Modified in 1.4.0

	public boolean getStorageAreaAuthzFixedDefined(String nameOfFS)
		throws NamespaceException; // 1.4.0
	...
	public int getNumberOfPoolMembers(String nameOfFS, int numOfPool)
		throws NamespaceException; // 1.4.0
