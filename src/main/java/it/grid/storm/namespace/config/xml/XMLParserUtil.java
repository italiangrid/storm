...
public class XMLParserUtil implements XMLConst {
	...
	public String getFSSpaceTokenDescription(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		String result = getStringProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.FS_SPACE_TOKEN_DESCRIPTION));
		return result;
	}
	...
	public String getRetentionPolicyType(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		String result = getStringProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.RETENTION_POLICY));
		return result;
	}
	...
	public String getAccessLatencyType(String nameOfFS) throws NamespaceException {
		...
		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		String result = getStringProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.ACCESS_LATENCY));
		return result;
	}

	public String getExpirationModeType(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		String result = getStringProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.EXPIRATION_MODE));
		return result;
	}

	public String getOnlineSpaceUnitType(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		String result = null;
		// Optional element
		if (isPresent(substituteNumberInFSElement(numOfFS,
			XMLConst.ONLINE_SIZE_UNIT))) {
			result = getStringProperty(substituteNumberInFSElement(numOfFS,
				XMLConst.ONLINE_SIZE_UNIT));
		} else { // Default value needed.
			result = XMLConst.DEFAULT_UNIT_TYPE;
			log.debug("Online Space Unit type for VFS(+'" + nameOfFS
				+ "') is absent. Default value ('" + result + "') will be used");
		}
		return result;
	}
	...
	public long getOnlineSpaceSize(String nameOfFS) throws NamespaceException {
		...
		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		long result = getLongProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.ONLINE_SIZE));
		return result;
	}

	public String getNearlineSpaceUnitType(String nameOfFS)
		throws NamespaceException {
	...
	public String getFSName(int numOfFS) throws NamespaceException {
		...
		return getStringProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.FILESYSTEM_NAME));
	}
	...
	public String getSpaceDriver(String nameOfFS) throws NamespaceException {
		...
		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		return getStringProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.FS_SPACE_DRIVER));
	}

	public boolean isDefaultElementPresent(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		boolean result = false;
		// FS_DEFAULTVALUES
		result = isPresent(substituteNumberInFSElement(numOfFS,
			XMLConst.FS_DEFAULTVALUES));
		return result;
	}
	...
	public String getDefaultSpaceType(String nameOfFS) throws NamespaceException {
		...
		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		return getStringProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.DEF_SPACE_TYPE));
	}

	public long getDefaultSpaceLifeTime(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		return getLongProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.DEF_SPACE_LT));
	}

	public long getDefaultSpaceGuarSize(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		return getLongProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.DEF_SPACE_GUARSIZE));
	}
	...
	public int getNumberOfProt(String nameOfFS) throws NamespaceException {
		...
		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		if (numOfFS == -1) {
			throw new NamespaceException("FS named '" + nameOfFS
				+ "' does not exist in config");
		}
		String protCount = substitutionNumber(XMLConst.PROTOCOL_COUNTING,
			XMLConst.FS_SUB_PATTERN, numOfFS);
		// log.debug( configuration.getString(protCount));
		return getPropertyNumber(protCount);
	}

	public String getProtName(String nameOfFS, int numOfProt)
		throws NamespaceException {

		return getStringProperty(substituteNumberInProtocolElement(nameOfFS,
			numOfProt, XMLConst.PROTOCOL_NAME));
	}

	public int getProtNumberByName(String nameOfFS, String nameOfProt)
		throws NamespaceException {

		int numFS = getFSNumber(nameOfFS);
		String collElem = substituteNumberInFSElement(numFS,
			XMLConst.PROTOCOL_BY_NAME);
		// log.debug("COLLECTION = "+collElem);
		return retrieveNumberByName(nameOfProt, collElem);
	}

	public String getProtSchema(String nameOfFS, int numOfProt)
		throws NamespaceException {

		return getStringProperty(substituteNumberInProtocolElement(nameOfFS,
			numOfProt, XMLConst.PROT_SCHEMA));
	}

	public String getProtHost(String nameOfFS, int numOfProt)
		throws NamespaceException {

		return getStringProperty(substituteNumberInProtocolElement(nameOfFS,
			numOfProt, XMLConst.PROT_HOST));
	}

	public String getProtPort(String nameOfFS, int numOfProt)
		throws NamespaceException {

		return getStringProperty(substituteNumberInProtocolElement(nameOfFS,
			numOfProt, XMLConst.PROT_PORT));
	}
	...
	public String getMapRuleName(int numOfMapRule) throws NamespaceException {
		...
		return getStringProperty(substituteNumberInMAPElement(numOfMapRule,
			XMLConst.MAP_RULE_NAME));
	}

	public String getMapRule_StFNRoot(String nameOfMapRule)
		throws NamespaceException {

		int numOfMapRule = retrieveNumberByName(nameOfMapRule,
			XMLConst.MAP_RULE_BY_NAME);
		return getStringProperty(substituteNumberInMAPElement(numOfMapRule,
			XMLConst.MAP_RULE_STFNROOT));
	}

	public String getMapRule_mappedFS(String nameOfMapRule)
		throws NamespaceException {

		int numOfMapRule = retrieveNumberByName(nameOfMapRule,
			XMLConst.MAP_RULE_BY_NAME);
		return getStringProperty(substituteNumberInMAPElement(numOfMapRule,
			XMLConst.MAP_RULE_MAPPED_FS));
	}
	...
	public String getApproachRuleName(int numOfAppRule) throws NamespaceException {
		...
		return getStringProperty(substituteNumberInAPPElement(numOfAppRule,
			XMLConst.APP_RULE_NAME));
	}

	public String getAppRule_SubjectDN(String nameOfAppRule)
		throws NamespaceException {
	...
	public String getAppRule_SubjectVO(String nameOfAppRule)
		throws NamespaceException {
	...
	public List getAppRule_AppFS(String nameOfAppRule) throws NamespaceException {
		...
		int numOfAppRule = retrieveNumberByName(nameOfAppRule,
			XMLConst.APP_RULE_BY_NAME);
		return getListValue(substituteNumberInAPPElement(numOfAppRule,
			XMLConst.APPROACHABLE_FS));
	}

	public String getAppRule_RelativePath(String nameOfAppRule)
		throws NamespaceException {

		int numOfAppRule = retrieveNumberByName(nameOfAppRule,
			XMLConst.APP_RULE_BY_NAME);
		return getStringProperty(substituteNumberInAPPElement(numOfAppRule,
			XMLConst.APP_SPACE_REL_PATH));
	}

	public String getAppRule_AnonymousHttpRead(String nameOfAppRule)
		throws NamespaceException {

		int numOfAppRule = retrieveNumberByName(nameOfAppRule,
			XMLConst.APP_RULE_BY_NAME);
		return getStringProperty(substituteNumberInAPPElement(numOfAppRule,
			XMLConst.APP_ANONYMOUS_HTTP_READ));
	}
	...
	public boolean getQuotaEnabled(String nameOfFS) throws NamespaceException {
		...
		boolean result = false;
		result = getBooleanProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.QUOTA_ENABLED));
		return result;
	}

	public boolean getQuotaDeviceDefined(String nameOfFS)
		throws NamespaceException {
	...
	public String getQuotaDevice(String nameOfFS) throws NamespaceException {
		...
		if (isPresent(substituteNumberInFSElement(numOfFS, XMLConst.QUOTA_DEVICE))) {
			result = getStringProperty(substituteNumberInFSElement(numOfFS,
				XMLConst.QUOTA_DEVICE));
		} else {
			throw new NamespaceException("Unable to find the element '"
				+ XMLConst.QUOTA_DEVICE + "' for the VFS:'" + nameOfFS + "'");
		}
		return result;
	}

	public boolean getQuotaFilesetDefined(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		boolean result = false;
		if (isPresent(substituteNumberInFSElement(numOfFS,
			XMLConst.QUOTA_FILE_SET_NAME))) {
			result = true;
		}
		return result;
	}
	...
	public String getQuotaFileset(String nameOfFS) throws NamespaceException {
		...
		if (isPresent(substituteNumberInFSElement(numOfFS,
			...
			throw new NamespaceException("Unable to find the element '"
				+ XMLConst.QUOTA_FILE_SET_NAME + "' for the VFS:'" + nameOfFS + "'");
		}
		return result;
	}

	public boolean getQuotaGroupIDDefined(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		boolean result = false;
		if (isPresent(substituteNumberInFSElement(numOfFS,
			XMLConst.QUOTA_GROUP_NAME))) {
			result = true;
		}
		return result;
	}
	...
	public String getQuotaGroupID(String nameOfFS) throws NamespaceException {
		...
		if (isPresent(substituteNumberInFSElement(numOfFS,
			...
			throw new NamespaceException("Unable to find the element '"
				+ XMLConst.QUOTA_GROUP_NAME + "' for the VFS:'" + nameOfFS + "'");
		}
		return result;
	}

	public boolean getQuotaUserIDDefined(String nameOfFS)
		throws NamespaceException {
	...
	public String getQuotaUserID(String nameOfFS) throws NamespaceException {
		...
		if (isPresent(substituteNumberInFSElement(numOfFS, XMLConst.QUOTA_USER_NAME))) {
			result = getStringProperty(substituteNumberInFSElement(numOfFS,
				XMLConst.QUOTA_USER_NAME));
		} else {
			throw new NamespaceException("Unable to find the element '"
				+ XMLConst.QUOTA_USER_NAME + "' for the VFS:'" + nameOfFS + "'");
		}
		return result;
	}
	...
	public String getStorageClass(String nameOfFS) throws NamespaceException {
		...
		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		if (isPresent(substituteNumberInFSElement(numOfFS,
			XMLConst.FS_STORAGE_CLASS))) {
			result = getStringProperty(substituteNumberInFSElement(numOfFS,
				XMLConst.FS_STORAGE_CLASS));
		} else {
			log.debug("Storage Class for VFS(+'" + nameOfFS
				+ "') is absent. Default value ('" + result + "') will be used.");
		}
		return result;
	}
	...
	private String substituteNumberInFSElement(int numberOfFS, String element)
		...
		String new_element = substitutionNumber(element, XMLConst.FS_SUB_PATTERN,
			numberOfFS);
		return new_element;
	}

	private String substituteNumberInACLEntryElement(String nameOfFS,
		int numberOfACLEntry, String element) throws NamespaceException {

		int numFS = getFSNumber(nameOfFS);
		if (numFS == -1) {
			throw new NamespaceException("Virtual File system (" + nameOfFS
				+ ") does not exists");
		}
		...
		String new_element = substitutionNumber(element, XMLConst.FS_SUB_PATTERN,
			numFS);
		new_element = substitutionNumber(new_element,
			XMLConst.ACL_ENTRY_SUB_PATTERN, numberOfACLEntry);
		return new_element;
	}

	private String substituteNumberInProtocolElement(String nameOfFS,
		int numberOfProtocol, String element) throws NamespaceException {
		...
		String new_element = substitutionNumber(element, XMLConst.FS_SUB_PATTERN,
			numFS);
		new_element = substitutionNumber(new_element, XMLConst.PROT_SUB_PATTERN,
			numberOfProtocol);
		return new_element;
	}

	private String substituteNumberInPoolElement(String nameOfFS,
		int numberOfPool, String element) throws NamespaceException {
		...
		String new_element = substitutionNumber(element, XMLConst.FS_SUB_PATTERN,
			numFS);
		new_element = substitutionNumber(new_element, XMLConst.POOL_SUB_PATTERN,
			numberOfPool);
		return new_element;
	}

	private String substituteNumberInMembersElement(String nameOfFS,
		int numOfPool, int numberOfMember, String element)
		throws NamespaceException {
		...
		new_element = substitutionNumber(new_element, XMLConst.POOL_SUB_PATTERN,
			numOfPool);
		new_element = substitutionNumber(new_element, XMLConst.MEMBER_SUB_PATTERN,
			numberOfMember);
		return new_element;
	}

	private String substituteNumberInMAPElement(int numberOfMapRule,
		...
		String new_element = substitutionNumber(element, XMLConst.MAP_SUB_PATTERN,
			numberOfMapRule);
		return new_element;
	}

	private String substituteNumberInAPPElement(int numberOfAppRule,
		String element) throws NamespaceException {
		...
		String new_element = substitutionNumber(element,
			XMLConst.APPRULE_SUB_PATTERN, numberOfAppRule);
		return new_element;
	}
	...
	private String getStringProperty(String element) throws NamespaceException {
		...
		try {
			...
			log.warn("[getStringProperty] Element <" + element
				+ "> does not contains a String value");
	...
	private String[] getListProperty(String element) throws NamespaceException {
		...
		try {
			...
			log.warn("[getListProperty] Element <" + element
				+ "> does not contains a String value");
		} catch (NoSuchElementException note) {
			log.warn("[getListProperty] Element <" + element
				+ "> does not exists in namespace configuration file");
	...
	public boolean getDefaultACLDefined(String nameOfFS)
		throws NamespaceException {
	...
	public int getNumberOfACL(String nameOfFS) throws NamespaceException {
		...
		String aclCount = substitutionNumber(XMLConst.ACL_ENTRY_COUNTING,
			XMLConst.FS_SUB_PATTERN, numOfFS);
		log.debug("ACL Count = " + aclCount);
		return getPropertyNumber(aclCount);
	}

	public String getGroupName(String nameOfFS, int aclEntryNumber)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		String aclCount = substitutionNumber(XMLConst.GROUP_NAME,
			XMLConst.FS_SUB_PATTERN, numOfFS);
		String result = null;
	...
	public String getPermissionString(String nameOfFS, int aclEntryNumber)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		String aclCount = substitutionNumber(XMLConst.PERMISSIONS,
			XMLConst.FS_SUB_PATTERN, numOfFS);
		String result = null;
		Object prop = configuration.getProperty(aclCount);
		if (prop != null) {
	...
	public String getStorageAreaAuthz(String nameOfFS, SAAuthzType type)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		if (type.equals(SAAuthzType.FIXED)) {
			return getStringProperty(substituteNumberInFSElement(numOfFS,
				XMLConst.SA_AUTHZ_FIXED));
		} else {
			return getStringProperty(substituteNumberInFSElement(numOfFS,
				XMLConst.SA_AUTHZ_DB));
		}
	}

	public SAAuthzType getStorageAreaAuthzType(String nameOfFS)
		throws NamespaceException {
		...
		throw new NamespaceException("Unable to find the SAAuthzType in "
			+ nameOfFS);
	}

	public boolean getStorageAreaAuthzFixedDefined(String nameOfFS)
		throws NamespaceException {
	...
	public boolean getStorageAreaAuthzDBDefined(String nameOfFS)
		throws NamespaceException {
	...
	public int getProtId(String nameOfFS, int numOfProt)
		throws NamespaceException {

		// int numOfProt = getProtNumberByName(nameOfFS, protName);
		String protId = substituteNumberInProtocolElement(nameOfFS, numOfProt,
			XMLConst.PROT_ID);
		// log.debug("ProtID : "+protId);
		if (isPresent(protId)) {
			return getIntProperty(substituteNumberInProtocolElement(nameOfFS,
				numOfProt, XMLConst.PROT_ID));
		} else {
			return -1;
		}
	}

	public boolean getOnlineSpaceLimitedSize(String nameOfFS)
		throws NamespaceException {

		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		boolean result = false;
		result = getBooleanProperty(substituteNumberInFSElement(numOfFS,
			XMLConst.LIMITED_SIZE));
		return result;
	}
	...
	public int getNumberOfPool(String nameOfFS) throws NamespaceException {
		...
		if (!getPoolDefined(nameOfFS))
			return 0;
		String protCount = substitutionNumber(XMLConst.POOL_COUNTING,
			XMLConst.FS_SUB_PATTERN, numOfFS);
		return getPropertyNumber(protCount);
	}
	...
	public String getBalancerStrategy(String nameOfFS) throws NamespaceException {
		...
		int numOfFS = retrieveNumberByName(nameOfFS, XMLConst.FS_BY_NAME);
		if (isPresent(substituteNumberInFSElement(numOfFS,
			XMLConst.BALANCE_STRATEGY))) {
			result = getStringProperty(substituteNumberInFSElement(numOfFS,
				XMLConst.BALANCE_STRATEGY));
		} else {
			throw new NamespaceException("Unable to find the element '"
				+ XMLConst.BALANCE_STRATEGY + "' for the VFS:'" + nameOfFS + "'");
		}
		return result;
	}

	public int getNumberOfPoolMembers(String nameOfFS, int poolCounter)
		throws NamespaceException {
		...
		String subTree = substituteNumberInPoolElement(nameOfFS, poolCounter,
			XMLConst.POOL);
		...
		if (members != null) {
			...
			log.error("Error during the retrieve of the number of pool member of "
				+ nameOfFS);
		}
		return numOfMembers;
	}

	public int getMemberID(String nameOfFS, int numOfPool, int memberNr)
		throws NamespaceException {

		return getIntProperty(substituteNumberInMembersElement(nameOfFS, numOfPool,
			memberNr, XMLConst.POOL_MEMBER_ID));
	}
	...
	public int getMemberWeight(String nameOfFS, int numOfPool, int memberNr)
		...
		return getIntProperty(substituteNumberInMembersElement(nameOfFS, numOfPool,
			memberNr, XMLConst.POOL_MEMBER_WEIGHT));
	}

	public String getBalancerStrategy(String fsName, int poolCounter)
		throws NamespaceException {

		String poolId = substituteNumberInPoolElement(fsName, poolCounter,
			XMLConst.BALANCE_STRATEGY);
		if (isPresent(poolId)) {
			return getStringProperty(substituteNumberInPoolElement(fsName,
				poolCounter, XMLConst.BALANCE_STRATEGY));
		} else {
			throw new NamespaceException("Unable to find the element '"
				+ XMLConst.BALANCE_STRATEGY + "' for the VFS:'" + fsName + "'");
		}
	}
