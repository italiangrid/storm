...
public class XMLParserUtil implements XMLConst {
  ...
  public boolean areThereSustitutionCharInside(String element) {
    ...
    result =
        (element.indexOf(XMLConst.PROT_SUB_PATTERN) != -1)
  ...
  public String getOnlineSpaceUnitType(String nameOfFS) throws NamespaceException {
    ...
    if (isPresent(substituteNumberInFSElement(numOfFS, XMLConst.ONLINE_SIZE_UNIT))) {
      ...
      log.debug(
          "Online Space Unit type for VFS(+'"
              + nameOfFS
              + "') is absent. Default value ('"
              + result
              + "') will be used");
    }
    return result;
  ...
  private String substituteNumberInACLEntryElement(
      String nameOfFS, int numberOfACLEntry, String element) throws NamespaceException {
  ...
  private String substituteNumberInProtocolElement(
      String nameOfFS, int numberOfProtocol, String element) throws NamespaceException {
  ...
  private String substituteNumberInMembersElement(
      String nameOfFS, int numOfPool, int numberOfMember, String element)
      throws NamespaceException {
  ...
  private int retrieveNumberByName(String name, String collectionElement, boolean logging) {
    ...
    if (prop != null) {
      ...
      log.warn(
          "[retrieveNumberByName_3] Element <"
              + collectionElement
  ...
  private int retrieveNumberByName(String name, String collectionElement) {
    ...
    if (prop != null) {
      ...
      log.warn(
          "[retrieveNumberByName_2] Element <"
              + collectionElement
              + "> does not exists in namespace configuration file");
    }
    return result;
  ...
  public int getNumberOfPool(String nameOfFS) throws NamespaceException {
    ...
    if (!getPoolDefined(nameOfFS)) return 0;
  ...
  public int getMemberWeight(String nameOfFS, int numOfPool, int memberNr)
    ...
    return getIntProperty(
        substituteNumberInMembersElement(
            nameOfFS, numOfPool, memberNr, XMLConst.POOL_MEMBER_WEIGHT));
  }
