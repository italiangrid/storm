...
public class XMLNamespaceParser implements NamespaceParser {
  ...
  private static Logger log = LoggerFactory.getLogger(XMLNamespaceParser.class);
  ...
  public XMLNamespaceParser(NamespaceLoader loader, boolean semanticCheckEnabled) {
    ...
    if (!validNamespaceConfiguration) {
      log.error("Invalid NAMESPACE! Please see the log.");
      System.exit(1);
    }
  ...
  private void updateTotalOnlineSizeFromGPFSQuota(String storageAreaName, VirtualFS storageArea,
