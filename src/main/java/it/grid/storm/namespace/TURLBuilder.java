...
public class TURLBuilder {
  ...
  private static TTURL buildTURL(Protocol protocol, Authority authority, String extraSlashes,
    ...
    try {
      turlString = protocol.getProtocolPrefix() + authority.toString() + extraSlashes
          + physicalFN.getValue();
  ...
  public static TTURL buildFileTURL(Authority authority, PFN physicalFN) {
    ...
    String extraSlashesForFile = StormConfiguration.getInstance().getExtraSlashesForFileTURL();
  ...
  public static TTURL buildGsiftpTURL(Authority authority, PFN physicalFN) {
    ...
    String extraSlashesForGSIFTP = StormConfiguration.getInstance().getExtraSlashesForGsiFTPTURL();
  ...
  public static TTURL buildRFIOTURL(Authority authority, PFN physicalFN) {
    ...
    String extraSlashesForRFIO = StormConfiguration.getInstance().getExtraSlashesForRFIOTURL();
  ...
  public static TTURL buildROOTTURL(Authority authority, PFN physicalFN) {
    ...
    String extraSlashesForROOT = StormConfiguration.getInstance().getExtraSlashesForROOTTURL();
