 ...
 * 
 * 
 * data children attr physical FILE T F T T FOLDER F T T T LINK F F T T SPACE F
 * F T T/F SPACE_BOUND T F T T IMAGINARY F F F F
 * 
 * 
 * <p>
...
public class StoRIType {
	...
	public static final StoRIType FILE = new StoRIType("file", true, false, true,
		true);
	// Means that StoRI corresponds to a FOLDER in underlying file system.
	public static final StoRIType FOLDER = new StoRIType("folder", false, true,
		true, true);
	// Means that StoRI corresponds to a LINK in underlying file system.
	public static final StoRIType LINK = new StoRIType("link", false, false,
		true, true);
	...
	public static final StoRIType SPACE = new StoRIType("space", false, false,
		true, false);
	...
	// for it.
	public static final StoRIType SPACE_BOUND = new StoRIType("spaceBound", true,
		false, true, true);
	// Means that StoRI has the correspondent FILE in underlying file system.
	public static final StoRIType IMAGINARY = new StoRIType("imaginary", false,
		false, false, false);

	public static final StoRIType UNKNOWN = new StoRIType("unknown", false,
		false, false, false);

	private StoRIType(String type, boolean dataContent, boolean children,
		boolean attributes, boolean physical) {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof StoRIType) {
			...
			if (storyType.toString().toLowerCase()
