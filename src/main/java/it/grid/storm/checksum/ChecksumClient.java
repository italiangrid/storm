...
public interface ChecksumClient {
	 ...
	 * 
	 * @param filePath
	 *          temporary workaround, checking existence of the file.
	...
	/**
	 * Contacts the checksum service and returns the computed checksum for the
	 * given file.
	 * 
	 * @param fileAbsolutePath
	 *          file to compute the checksum for.
	 * @param algorithm
	 *          checksum algorithm.
	 * @return the computed checksum for the given file.
	 * @throws IOException
	 *           in case of error contacting the remote service
	 * @throws ChecksumRuntimeException
	 *           in case there was an error computing the checksum. The exception
	 *           message is set with the error explanation.
	 */
	public String getChecksum(String fileAbsolutePath, String algorithm)
		throws IOException, ChecksumRuntimeException;

	/**
	 * Set the service endpoint to contact.
	 * 
	 * @param service
	 *          endpoint (e.g. http://host:port/).
	 */
