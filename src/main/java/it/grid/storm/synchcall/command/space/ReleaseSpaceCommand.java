...
/**
 * This class represents the ReleaseSpaceManager Class. This class has a reseveSpace method that
 * perform all operation needed to satisfy a SRM space release request.
 */
