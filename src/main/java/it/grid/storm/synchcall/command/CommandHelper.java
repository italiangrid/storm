...
public class CommandHelper {
  ...
  private static String getStatusMessage(TStatusCode statusCode) {
    ...
    if (result == null) return FAILED_STRING;
  ...
  public static TReturnStatus buildStatus(TStatusCode statusCode, String explaination)
    ...
    if (explaination == null || explaination.isEmpty()) {
      throw new IllegalArgumentException(
          "Unable to build the status, null or empty argument: explaination=" + explaination);
    }
    return new TReturnStatus(statusCode, explaination);
  }

  public static TSURLReturnStatus buildStatus(TSURL surl, TReturnStatus returnStatus)
      throws IllegalArgumentException, IllegalStateException {

    if (surl == null || returnStatus == null) {
      throw new IllegalArgumentException(
          "Unable to build the status, null arguments: surl="
              + surl
              + " returnStatus="
              + returnStatus);
    }
  ...
  public static void printRequestOutcome(
      String srmCommand, Logger log, TReturnStatus status, InputData inputData) {

    log.info(
        "{}: user <{}> Request {} with: [status: {}]",
        srmCommand,
  ...
  public static void printRequestOutcome(
    ...
    log.info(
        "{}: user <{}> Request for [SURL: {}] {} with: [status: {}]",
        srmCommand,
        DataHelper.getRequestor(inputData),
        surls,
        getStatusMessage(status.getStatusCode()),
  ...
  public static void printRequestOutcome(
    ...
    log.info(
        "{}: user <{}> Request for [token: {}] for [SURL: {}] {} with: [status: {}]",
        srmCommand,
        DataHelper.getRequestor(inputData),
        token,
        surls,
  ...
  public static void printRequestOutcome(
    ...
    log.info(
        "{}: user <{}> Request for [token: {}] {} with: [status: {}]",
        srmCommand,
        DataHelper.getRequestor(inputData),
        token,
        getStatusMessage(status.getStatusCode()),
  ...
  public static void printSurlOutcome(
      String srmCommand, Logger log, TReturnStatus status, InputData inputData, TSURL surl) {

    log.info(
        "{}: user <{}> operation on [SURL: {}] {} with: [status: {}]",
        srmCommand,
        DataHelper.getRequestor(inputData),
        surl,
        getStatusMessage(status.getStatusCode()),
  ...
  public static void printSurlOutcome(
    ...
    log.info(
        "{}: user <{}> operation for token [token:{}] on [SURL: {}] {} with: [status: {}]",
        srmCommand,
        DataHelper.getRequestor(inputData),
        token,
        surl,
