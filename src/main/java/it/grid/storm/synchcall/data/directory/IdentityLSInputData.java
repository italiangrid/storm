 ...
 * 
 * This class represents the LS Input Data associated with the SRM request, that
 * is it contains info about: ...,ecc.
 * 
 * @author lucamag
 * @date May 28, 2008
 * 
...
public class IdentityLSInputData extends AnonymousLSInputData implements
	IdentityInputData {

	private final GridUserInterface auth;

	public IdentityLSInputData(GridUserInterface auth, ArrayOfSURLs surlArray,
		TFileStorageType fileStorageType, Boolean fullDetList, Boolean allLev,
		Integer numOfLev, Integer offset, Integer count)
		throws IllegalArgumentException {

		super(surlArray, fileStorageType, fullDetList, allLev, numOfLev, offset,
			count);
		if (auth == null) {
