...
public class IdentityReserveSpaceInputData extends
	AnonymousReserveSpaceInputData implements Serializable, IdentityInputData {

	private static final long serialVersionUID = 2840674835389671669L;
	private final GridUserInterface auth;

	public IdentityReserveSpaceInputData(GridUserInterface auth,
		String spaceTokenAlias, TRetentionPolicyInfo retentionPolicyInfo,
		...
		super(spaceTokenAlias, retentionPolicyInfo, spaceDesired, spaceGuaranteed,
			storageSystemInfo);
		if (auth == null) {
