...
public class AnonymousManageFileTransferFilesInputData extends AbstractInputData
    implements ManageFileTransferFilesInputData {
  ...
  public AnonymousManageFileTransferFilesInputData(ArrayOfSURLs arrayOfSURLs) {
    ...
    if (arrayOfSURLs == null || arrayOfSURLs.size() == 0) {
      throw new IllegalArgumentException(
          "Unable to create the object, invalid arguments: " + "arrayOfSURLs=" + arrayOfSURLs);
    }
