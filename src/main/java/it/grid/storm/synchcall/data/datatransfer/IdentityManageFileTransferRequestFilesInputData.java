...
public class IdentityManageFileTransferRequestFilesInputData extends
	AnonymousManageFileTransferRequestFilesInputData implements IdentityInputData {

	private final GridUserInterface auth;

	public IdentityManageFileTransferRequestFilesInputData(
		GridUserInterface auth, TRequestToken requestToken,
