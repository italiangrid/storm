...
public class AnonymousLSInputData extends AbstractInputData implements LSInputData
{
    ...
    public AnonymousLSInputData(ArrayOfSURLs surlArray, TFileStorageType fileStorageType,
            Boolean fullDetList, Boolean allLev, Integer numOfLev, Integer offset, Integer count)
        throws IllegalArgumentException
    {
        if (surlArray == null)
        {
            throw new IllegalArgumentException("Unable to create the object, invalid arguments: surlArray=" + surlArray);
        }
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.directory.LSInputData#getStorageTypeSpecified()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.directory.LSInputData#getFullDetailedList()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.directory.LSInputData#getAllLevelRecursive()
     */
    @Override
