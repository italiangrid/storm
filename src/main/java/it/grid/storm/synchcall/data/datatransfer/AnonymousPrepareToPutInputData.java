 ...
 *
 */
public class AnonymousPrepareToPutInputData extends AnonymousFileTransferInputData implements PrepareToPutInputData
{
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.datatransfer.PrepareToPutInputData#getOverwriteMode()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.datatransfer.PrepareToPutInputData#getFileSize()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.datatransfer.PrepareToPutInputData#getDesiredFileLifetime()
     */
    @Override
