 ...
 * <p>
 * 
 * This class represents the PutDone Output Data associated with the SRM request
 * PutDone
 * 
 * Authors:
 * 
...
public class ManageFileTransferOutputData implements OutputData {
	...
	private static final Logger log = LoggerFactory
		.getLogger(ManageFileTransferOutputData.class);
	private final TReturnStatus returnStatus;
	private final ArrayOfTSURLReturnStatus arrayOfFileStatus;

	public ManageFileTransferOutputData(TReturnStatus retStatus)
		throws IllegalArgumentException {

		if (retStatus == null) {
			log.error("Unable to create the object, invalid arguments: retStatus="
				+ retStatus);
			throw new IllegalArgumentException(
				"Unable to create the object, invalid arguments");
		}
	...
	public ManageFileTransferOutputData(TReturnStatus retStatus,
		ArrayOfTSURLReturnStatus arrayOfFileStatus) throws IllegalArgumentException {

		if (retStatus == null || arrayOfFileStatus == null
			|| arrayOfFileStatus.getArray().isEmpty()) {
			log.error("Unable to create the object, invalid arguments: retStatus="
				+ retStatus + " arrayOfFileStatus=" + arrayOfFileStatus);
			throw new IllegalArgumentException(
				"Unable to create the object, invalid arguments");
		}
		this.returnStatus = retStatus;
