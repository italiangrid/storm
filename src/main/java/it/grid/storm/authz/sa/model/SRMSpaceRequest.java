...
public class SRMSpaceRequest {
  ...
  public static final SRMSpaceRequest PTP =
      new SRMSpaceRequest(
          "srmPrepareToPut", "PTP", new SpaceOperation[] {SpaceOperation.WRITE_TO_SPACE});

  public static final SRMSpaceRequest PTG =
      new SRMSpaceRequest(
          "srmPrepareToGet",
          "PTG",
          new SpaceOperation[] {
  ...
  public static final SRMSpaceRequest BOL =
      new SRMSpaceRequest(
          "srmBringOnLine",
          "BOL",
          new SpaceOperation[] {
  ...
  public static final SRMSpaceRequest CPto =
      new SRMSpaceRequest(
          "srmCopy to", "CPto", new SpaceOperation[] {SpaceOperation.WRITE_TO_SPACE});
  public static final SRMSpaceRequest CPfrom =
      new SRMSpaceRequest(
          "srmCopy from",
          "CPfrom",
          new SpaceOperation[] {
  ...
  // Space Operations
  public static final SRMSpaceRequest PFS =
      new SRMSpaceRequest(
          "srmPurgeFromSpace", "PFS", new SpaceOperation[] {SpaceOperation.PURGE_FROM_SPACE});
  public static final SRMSpaceRequest RS =
      new SRMSpaceRequest(
          "srmReleaseSpace", "RS", new SpaceOperation[] {SpaceOperation.RELEASE_SPACE});
  public static final SRMSpaceRequest QS =
      new SRMSpaceRequest(
          "srmGetSpaceMetadata",
          "QS",
  ...
  // OVERLOAD with OP
  public static final SRMSpaceRequest RM =
      new SRMSpaceRequest("srmRemove", "RM", new SpaceOperation[] {SpaceOperation.WRITE_TO_SPACE});
  public static final SRMSpaceRequest RMD =
      new SRMSpaceRequest(
          "srmRemoveDir", "RMD", new SpaceOperation[] {SpaceOperation.WRITE_TO_SPACE});
  public static final SRMSpaceRequest MD =
      new SRMSpaceRequest("srmMakeDir", "MD", new SpaceOperation[] {SpaceOperation.WRITE_TO_SPACE});
  public static final SRMSpaceRequest LS =
      new SRMSpaceRequest("srmLS", "LS", new SpaceOperation[] {SpaceOperation.READ_FROM_SPACE});
  public static final SRMSpaceRequest MV =
