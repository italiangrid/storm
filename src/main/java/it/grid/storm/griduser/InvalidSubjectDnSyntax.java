...
/**
 * Thrown when a invalid subject DN is detected by the {@link
 * it.grid.storm.griduser.VomsGridUser#VomsGridUser(String,String[])} constructor. Holds and returns
 * the offending subject DN string.
 */
