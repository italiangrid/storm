...
public class ExactDnMatch implements DnMatch {
	...
	/**
	 * Return <code>true</code> if <code>fixedDn</code> is the initial segment of
	 * <code>proxyDn</code>, and the remaining part of <code>proxyDn</code>
	 * consists only of "CN=..." fields. (That is, <code>proxyDn</code> may be a
	 * proxy DN derived from <code>fixedDn</code> by a proxy delegation process,
	 * according to RFC3820.
	 * 
