...
public class GridUserManager {
  ...
  public static GridUserInterface makeVOMSGridUser(String dn, String proxy, FQAN[] fqans)
    ...
    if (proxy == null || dn == null || fqans == null || fqans.length == 0) {
      throw new IllegalArgumentException(
          "Unable to make VomsGridUser. Inavlid arguments: dn=\'"
              + dn
              + "\' fqans=\'"
              + fqans
              + "\' proxy=\'"
  ...
  public static GridUserInterface makeVOMSGridUser(String dn, String vo)
    ...
    if (vo == null || dn == null) {
      throw new IllegalArgumentException(
          "Unable to make VomsGridUser. Inavlid arguments: dn=\'" + dn + "\' vo=\'" + vo + "\'");
    }
    GridUserInterface gridUser = null;
  ...
  public static GridUserInterface makeVOMSGridUser(String dn, String[] fqansString)
      throws IllegalArgumentException {

    if (fqansString == null || fqansString.length == 0) {
      throw new IllegalArgumentException(
          "Unable to make VomsGridUser. Invalid fqansString argument: " + fqansString);
    }
