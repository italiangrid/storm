...
public class GridUserFactory {
  ...
  private MapperInterface makeMapperClass(String mapperClassName) throws GridUserException {
    ...
    try {
      ...
      throw new GridUserException(
          "Cannot load Mapper Driver instance without a valid Mapper Driver Class Name!", e);
    }
    ...
    try {
      Constructor<MapperInterface>[] constructors =
          (Constructor<MapperInterface>[]) mapperClass.getConstructors();
      boolean found = false;
      ...
      if (found) {
        ...
        try {
          ...
          if (Modifier.isStatic(method.getModifiers())) {
            ...
            log.error(
                "Unable to instantiate the class using eiter no args constructor niether getInstance method. getInstance exists but is not static");
            throw new GridUserException(
      ...
      log.error(e.getMessage(), e);
      throw new GridUserException(
          "Cannot create a new Instance of the Mapper Driver named :'" + mapperClassName + "'");
