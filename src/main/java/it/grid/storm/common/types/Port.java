...
public class Port {
  ...
  /**
   * Static method used to make a non empty Port object. It requires an int between 0 and 65535
   * representing the port: if the limits are exceeded then an InvalidPortAttributeException is
   * thrown.
   */
  ...
  /** Method that returns an int representing this port. An empty port will return -1. */
  public int toInt() {
