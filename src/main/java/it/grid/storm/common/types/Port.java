...
public class Port {
	...
	/*
	 * public static void main(String[] args) { // //Testing empty Port creation
	 * System.out.println("Testing empty Port creation..."); Port pe1 =
	 * Port.makeEmpty();
	 * System.out.println("pe1 is an empty Port; should see empty port:"
	 * +pe1+"; should see hashCode -1:"
	 * +pe1.hashCode()+"; it is empty so should see true:"
	 * +pe1.isEmpty()+"; toInt should be -1:"
	 * +pe1.toInt()+"; getValue():"+pe1.getValue()); Port pe2 = Port.makeEmpty();
	 * System.out.println("pe2 is an empty Port; should see empty port:"+pe2+
	 * "; should see hashCode -1:"
	 * +pe2.hashCode()+"; it is empty so should see true:"
	 * +pe2.isEmpty()+"; toInt should be -1:"
	 * +pe2.toInt()+"; getValue():"+pe2.getValue());
	 * System.out.println("pe1.equals(pe2) should see true:"+
	 * pe1.equals(pe2)+"; pe2.equals(pe1) should see true:"+pe2.equals(pe1)); //
	 * //Testing correct port creation
	 * System.out.println("\n\nTesting correct creation of Port objects..."); try
	 * { Port p0 = Port.make(0);
	 * System.out.println("Port 0 - should see 0: "+p0+"; hashCode:"
	 * +p0.hashCode()+
	 * "; isEmpty should be false:"+p0.isEmpty()+"; toInt should be 0:"
	 * +p0.toInt()+"; getValue() should be 0:"+p0.getValue()); Port p65535 =
	 * Port.make(65535);
	 * System.out.println("Port 65535 - should see 65535: "+p65535
	 * +"; hashCode:"+p65535
	 * .hashCode()+"; isEmpty should be false:"+p65535.isEmpty
	 * ()+"; toInt should be 65535:"
	 * +p65535.toInt()+"; getValue() should be 65535:"+p65535.getValue());
	 ...
	 * ); System.out.print("Attempting creation with -1: "); try { Port errp =
	 * Port.make(-1); System.out.println("Should not see this!"); } catch
	 * (InvalidPortAttributeException e) {
	 * System.out.println(" creation failed as expected. " + e); }
	 * System.out.print("Attempting creation with 65536: "); try { Port errp =
	 * Port.make(65536); System.out.println("Should not see this!"); } catch
	 * (InvalidPortAttributeException e) {
	 * System.out.println(" creation failed as expected. " + e); } }
	 */
}
