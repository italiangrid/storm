 ...
 */
/**
 * This class represents a unit of measure for EstimatedTime; it contains a conversion factor for
 * changing from one to the other units.
 *
 * @author Ezio Corso
...
public abstract class TimeUnit implements Serializable {
  ...
  /** This method returns a converson factor: the amout of seconds present in 1 unit of this. */
