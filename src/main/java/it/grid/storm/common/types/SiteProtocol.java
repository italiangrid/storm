...
public class SiteProtocol {
	...
	/**
	 * Facility method to obtain a SiteProtocol object from its String
	 * representation. An IllegalArgumentExceptin is thrown if the supplied String
	 * does not have a SiteProtocol counterpart. The supplied String may contain
	 * white spaces and be in a mixture of upper and lower case characters.
	 */
	public static SiteProtocol fromString(String value)
