...
/**
 * This class represents an Exception throw nwhen attempting to create a PathName
...
public class InvalidPFNAttributeException extends Exception {
    ...
    public String toString() {
        return "Attempt to create PFN with invalid attributes: nullName="+nullName+"; emptyName="+emptyName+"; not-beginning-with-/="+wrong;
    }
