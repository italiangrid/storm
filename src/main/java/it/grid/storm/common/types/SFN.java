...
public class SFN {
	...
	/**
	 * Static method that returns an SFN from a String representation. If the
	 * supplied String is null or malformed, an InvalidSFNAttributesException is
	 * thrown.
	 * 
	 * @param surlString
	 *          a surl string without the protocol schema part
	 * @return
	...
	/**
	 * Returns an SFN from the received string that is supposed to contain the
	 * port and to be in simple form
	 * 
	 * @param surlString
	 * @param colon
	 * @param slash
	...
	/**
	 * Returns an SFN from the received string that is supposed to not contain the
	 * port and to be in query form
	 * 
	 * @param surlString
	 * @param slash
	 * @param question
	...
	/**
	 * Method that returns th EndPoint specified in This SFN. If This is an empty
	 * SFN, then an Empty EndPoint is returned; likewise if none was specified at
	 * creation time.
	 */
