...
public class Machine {
  ...
  /**
   * Static method requiring the name of the machine: it cannot be null or the empty String,
   * otherwise an InvalidMachineAttributeException is thrown. Beware that any empty space is
   * removed.
   */
  public static Machine make(String s) throws InvalidMachineAttributeException {

    if ((s == null) || (s.equals(""))) throw new InvalidMachineAttributeException(s);
