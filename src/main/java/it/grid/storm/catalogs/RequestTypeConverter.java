...
class RequestTypeConverter {
	...
	/**
	 * Method that returns the String used by DB to represent the given
	 * TRequestType. An empty String is returned if no match is found.
	 */
	...
	/**
	 * Method that returns the TRequestType used by StoRM to represent the
	 * supplied String representation of DB. TRequestType.EMPTY is returned if no
	 * StoRM type is found.
	 */
