...
/**
 * This class represents a ReducedCopyChunkData, that is part of a multifile Copy srm request. It
 * contains data about: the requestToken, the fromSURL, the toSURL, return status of the file
...
public class ReducedCopyChunkData {
  ...
  public ReducedCopyChunkData(TSURL fromSURL, TSURL toSURL, TReturnStatus status)
    ...
    if (fromSURL == null || toSURL == null || status == null) {
      throw new InvalidReducedCopyChunkDataAttributesException(fromSURL, toSURL, status);
    }
