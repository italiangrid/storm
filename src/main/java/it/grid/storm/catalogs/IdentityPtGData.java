...
public class IdentityPtGData extends AnonymousPtGData implements IdentityInputData {
	 ...
	 */
    public IdentityPtGData(GridUserInterface auth, TSURL SURL, TLifeTimeInSeconds lifeTime, TDirOption dirOption,
            TURLPrefix desiredProtocols, TSizeInBytes fileSize, TReturnStatus status, TTURL transferURL)
        throws InvalidPtGDataAttributesException, InvalidFileTransferDataAttributesException, InvalidSurlRequestDataAttributesException, IllegalArgumentException
    {
