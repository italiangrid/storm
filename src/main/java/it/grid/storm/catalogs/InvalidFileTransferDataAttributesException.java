...
public class InvalidFileTransferDataAttributesException
    extends InvalidSurlRequestDataAttributesException {
  ...
  public InvalidFileTransferDataAttributesException(
      TSURL SURL, TURLPrefix transferProtocols, TReturnStatus status, TTURL transferURL) {
