...
public class CopyData extends SurlMultyOperationRequestData {
  ...
  /**
   * specifies the behaviour in case of existing files for Put part of the copy (could be local or
   * remote!)
   */
  ...
  public CopyData(
      ...
      throws InvalidCopyDataAttributesException, InvalidSurlRequestDataAttributesException {

    super(fromSURL, status);
    if (destinationSURL == null
        || lifetime == null
        || fileStorageType == null
        || spaceToken == null
        || overwriteOption == null) {
      throw new InvalidCopyDataAttributesException(
          fromSURL,
          destinationSURL,
          lifetime,
          fileStorageType,
