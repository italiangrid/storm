...
/**
 * Class that represents an Exception thrown by the ReservedSpaceCatalog when it is asked to
 * retrieve info from the persistence but the raw data is invalid and does not allow a well-formed
 * domain obejcts to be created.
 *
 * @author: EGRID ICTP
 * @version: 1.0
 * @date: June 2005
...
public class InvalidRetrievedDataException extends Exception {
  ...
  public InvalidRetrievedDataException(
      String requestToken,
      String requestType,
  ...
  public String toString() {
    ...
    return "InvalidRetrievedDataException: token="
        + requestToken
        + " type="
        + requestType
        + " total-files="
