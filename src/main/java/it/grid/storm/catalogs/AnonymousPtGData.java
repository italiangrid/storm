...
public class AnonymousPtGData extends AnonymousFileTransferData implements PtGData {
  ...
  public AnonymousPtGData(
    ...
    if (lifeTime == null || dirOption == null || fileSize == null) {
      log.debug(
          "Invalid arguments: lifeTime={}, dirOption={}, fileSize={}",
          lifeTime,
          dirOption,
          fileSize);
      throw new InvalidPtGDataAttributesException(
          SURL, lifeTime, dirOption, desiredProtocols, fileSize, status, transferURL);
    }
