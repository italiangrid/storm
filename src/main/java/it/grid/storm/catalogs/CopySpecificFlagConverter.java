 ...
 * TOverwriteMode+TDirOption request specific information, and Flags in storm_copy_filereq.
 *
...
class CopySpecificFlagConverter {
   ...
   *
   * <p>0 NEVER + source NOT directory 1 ALWAYS + source NOT directory 2 WHENFILESAREDIFFERENT +
   * source NOT directory 4 NEVER + source is directory 5 ALWAYS + source is directory 6
   * WHENFILESAREDIFFERENT + source is directory
   */
   ...
   * isSourceADirectory boolean. -1 is returned if no match is found.
   */
