...
public class BoLData extends AnonymousFileTransferData {
  ...
  public BoLData(
      ...
      throws InvalidFileTransferDataAttributesException, InvalidBoLDataAttributesException,
    ...
    if (lifeTime == null || dirOption == null || fileSize == null) {
      throw new InvalidBoLDataAttributesException(
          fromSURL, lifeTime, dirOption, desiredProtocols, fileSize, status, transferURL);
    }
