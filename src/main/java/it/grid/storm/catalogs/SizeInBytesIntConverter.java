 ...
 * moreover StoRM does accept 0 as a valid TSizeInBytes, so it _is_ important to
 * use this converter!
 * 
 * @author EGRID ICTP
 * @version 2.0
...
public class SizeInBytesIntConverter {
	...
	/**
	 * Method that transaltes the Empty TSizeInBytes into the empty representation
	 * of DB which is 0. Any other int is left as is.
	 */
	...
	/**
	 * Method that returns the int as is, except if it is 0 which DB interprests
	 * as empty field: in that case it then returns the Empty TSizeInBytes int
	 * representation.
	 */
