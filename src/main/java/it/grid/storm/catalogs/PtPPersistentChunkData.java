 ...
 * expectedFileSize, the desired transferProtocols in order of preference, the
 * overwriteOption to be applied in case the file already exists, the
...
public class PtPPersistentChunkData extends IdentityPtPData implements
	...
	public PtPPersistentChunkData(GridUserInterface auth,
		TRequestToken requestToken, TSURL toSURL, TLifeTimeInSeconds pinLifetime,
		...
		throws InvalidPtPPersistentChunkDataAttributesException,
