 ...
 * BoLChunkData are invalid, that is if any of the following is _null_: requestToken, fromSURL,
...
public class InvalidBoLChunkDataAttributesException extends Exception {
     ...
     */
    public InvalidBoLChunkDataAttributesException(TRequestToken requestToken, TSURL fromSURL,
            TLifeTimeInSeconds lifeTime, TDirOption dirOption, TURLPrefix transferProtocols,
