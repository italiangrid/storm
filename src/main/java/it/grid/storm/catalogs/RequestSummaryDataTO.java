...
public class RequestSummaryDataTO {
	...
	public int hashCode() {
		...
		result = prime * result
			+ (int) (deferredStartTime ^ (deferredStartTime >>> 32));
		...
		result = prime
			* result
			+ (int) (remainingDeferredStartTime ^ (remainingDeferredStartTime >>> 32));
		result = prime * result
			+ (int) (remainingTotalTime ^ (remainingTotalTime >>> 32));
		result = prime * result
		...
		result = prime * result
			+ ((vomsAttributes == null) ? 0 : vomsAttributes.hashCode());
		return result;
	}
