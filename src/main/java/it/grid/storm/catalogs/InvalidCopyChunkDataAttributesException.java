 ...
 * CopyChunkData are invalid, that is if any of the following is _null_: requestToken, fromsURL,
 * toSURL, lifetime, fileStorageType, spaceToken, overwriteOption, status.
 *
...
public class InvalidCopyChunkDataAttributesException extends Exception {
  ...
  public InvalidCopyChunkDataAttributesException(
