...
public abstract class SurlRequestData implements RequestData {
  ...
  private static final Logger log = LoggerFactory.getLogger(SurlRequestData.class);
  ...
  /**
   * Method that sets the status of this request to SRM_SUCCESS; it needs the explanation String
