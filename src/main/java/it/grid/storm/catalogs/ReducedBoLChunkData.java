...
/**
 * This class represents a ReducedBringOnLineChunkData, that is part of a
 * multifile PrepareToGet srm request. It is closely related to BoLChunkData but
 ...
 * amunt of information is needed instead of full blown BoLChunkData.
 * 
 * @author CNAF
 * @date Aug 2009
 * @version 1.0
...
public class ReducedBoLChunkData implements ReducedChunkData {
	...
	private static final Logger log = LoggerFactory
		.getLogger(ReducedBoLChunkData.class);
