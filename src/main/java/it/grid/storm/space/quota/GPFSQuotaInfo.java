...
public class GPFSQuotaInfo {
	...
	public enum QuotaType {
		USR(0, "USR"), GRP(1, "GRP"), FILESET(2, "FILESET"), UNDEFINED(-1,
			"UNDEFINED");
	...
	public enum EntryType {
		DEFAULT_ON(0, "default on"), DEFAULT_OFF(1, "default off"), EXPLICIT_QUOTA(
			2, "e"), DEFAULT_QUOTA(3, "d"), INITIAL_QUOTA(4, "i"), UNDEFINED(-1, "?");
	...
	/**
	 * 
	 0 <DeviceName> devicename 1 <Name> root 2 <QuotaType> USR 3 <CurrentUsage>
	 * 15617856 4 <SoftLimit> 0 5 <HardLimit> 0 6 <SpaceInDoubt> 42976 7
	 * <GracePeriod> none 8 <sep> | 9 <CurrentNumbFiles> 56 0 <SoftLimit> 0 1
	 * <HardLimit> 0 2 <FilesInDoubt> 34 3 <GracePeriod> none 4 <EntryType> i
	 */
	 ...
	 * 
	 * 
	 * <DeviceName> devicename <Name> root <QuotaType> USR <CurrentUsage> 15617856
	 * <SoftLimit> 0 <HardLimit> 0 <SpaceInDoubt> 42976 <GracePeriod> none <sep> |
	 * <CurrentNumbFiles> 56 <SoftLimit> 0 <HardLimit> 0 <FilesInDoubt> 34
	 * <GracePeriod> none <EntryType> i
	 * 
	 * @param output
	 *          String
	...
	public void parseMMLSQuotaCommandOutput(String line, Quota quotaElement) {
		...
		// Filesystem type KB quota limit in_doubt grace | files quota limit
	...
	/**
	 * -- OK -- []# /usr/lpp/mmfs/bin/mmlsquota -j data1 gemss_test Block Limits |
	 * File Limits Filesystem type KB quota limit in_doubt grace | files quota
	 * limit in_doubt grace Remarks gemss_test FILESET 512 2147483648 2147483648 0
	 * none | 3128 0 0 0 none []#
	 * 
	 * -- ERR1 (wrong device) -- [root@vm-storage-03 backend-server]#
	 * /usr/lpp/mmfs/bin/mmlsquota -j data1 gemss_test3 mmlsquota: File system
	 * gemss_test3 is not known to the GPFS cluster. mmlsquota: Command failed.
	 * Examine previous error messages to determine cause. [root@vm-storage-03
	 * backend-server]#
	 * 
	 * -- ERR2 (wrong fileset) -- [root@vm-storage-03 backend-server]#
	 * /usr/lpp/mmfs/bin/mmlsquota -j dat991 gemss_test dat991: no such fileset in
	 * quota enabled file systems mmlsquota: Command failed. Examine previous
	 * error messages to determine cause. [root@vm-storage-03 backend-server]#
	 */
