...
public class UsedSpaceFile {
  ...
  public UsedSpaceFile(String iniFilePath) throws InvalidFileFormatException, IOException {
  ...
  public SaUsedSize getSAUsedSize(String saName) {
    ...
    Preconditions.checkArgument(
        hasSA(saName), saName + " section not found into used-space ini file");
      ...
      switch (Key.valueOf(optionKey)) {
        ...
        case checktime:
          try {
            ...
            log.error(
                "{}.{} is not a valid Date value. ParseException: {}",
                saName,
                optionKey,
                e.getMessage());
          }
  ...
  private Date parseDate(String dateStr) throws ParseException {
    ...
    try {
      ...
      log.debug(
          "Unable to parse date {} using RFC2822 "
      ...
      try {
        ...
        log.warn(
            "Unable to parse the date {} with default formatter. " + "ParseException: {}",
            dateStr,
            e.getMessage());
        throw e;
      }
