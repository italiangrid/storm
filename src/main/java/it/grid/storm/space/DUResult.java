...
public class DUResult implements Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        return new DUResult(this.getSize(), this.absRootPath, this.startTime, this.durationTime, this.cmdResult);
    }
     ...
     * @param cmdResult
     */
    public DUResult(long size, String absRootPath, Date startTime, long durationTime, ExitCode cmdResult) {
        super();
        this.size = size;
