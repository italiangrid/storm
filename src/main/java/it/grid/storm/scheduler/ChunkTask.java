...
////            this.userDN = ptgToDo.getUserDN();
////            this.surl = ptgToDo.getSURL();
////            this.requestToken = ptgToDo.getRequestToken();
////        }
////        else
////        {
////            if (type.equals(ChunkType.PREPARE_TO_PUT))
////            {
////                PtP ptpToDo = (PtP) todo;
////                String requestToken = null;
////                if(todo instanceof PtPChunk)
////                {
////                    requestToken = ((PtPChunk)ptpToDo).getRequestToken();
////                    this.userDN = ptpToDo.getUserDN();
////                    this.surl = ptpToDo.getSURL();
...
////            }
////        }
//        this.isAsynchTask = todo instanceof DelegableChunk;
//    }
    ...
    public void logExecution()
    {
        ...
        if (todo instanceof RequestChunk)
        {
            event = new LogEvent(buildOperationType(), this.userDN, this.surl, this.getStartExecutionTime(),
                                 this.howlongInExecution(), this.requestToken, this.successResult);
        }
        else
        {
            event = new LogEvent(buildOperationType(), this.userDN, this.surl, this.getStartExecutionTime(),
