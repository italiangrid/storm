...
public class TDirOption {
	 ...
	 * recursion on all subdirectories is wanted. If allLevel is false, an
	 ...
	 * System.out.println("Testing constructors..."); try { TDirOption d1 = new
	 * TDirOption(true,true);
	 * System.out.println(1+" "+d1+"; isASourceDirectory:"+d1
	 * .isDirectory()+"; isAllLevelRecursive:"
	 * +d1.isAllLevelRecursive()+"; numLevel:"+d1.getNumLevel()); TDirOption d2 =
	 * new TDirOption(false,true);
	 * System.out.println(2+" "+d2+"; isASourceDirectory:"
	 * +d2.isDirectory()+"; isAllLevelRecursive:"
	 * +d2.isAllLevelRecursive()+"; numLevel:"+d2.getNumLevel()); TDirOption d3 =
	 * new TDirOption(true,true,0);
	 * System.out.println(3+" "+d3+"; isASourceDirectory:"
	 * +d3.isDirectory()+"; isAllLevelRecursive:"
	 * +d3.isAllLevelRecursive()+"; numLevel:"+d3.getNumLevel()); TDirOption d4 =
	 * new TDirOption(true,false,10);
	 * System.out.println(4+" "+d4+"; isASourceDirectory:"
	 * +d4.isDirectory()+"; isAllLevelRecursive:"
	 * +d4.isAllLevelRecursive()+"; numLevel:"+d4.getNumLevel()); TDirOption d5 =
	 * new TDirOption(false,false,-10);
	 * System.out.println(5+" "+d5+"; isASourceDirectory:"
	 * +d5.isDirectory()+"; isAllLevelRecursive:"
	 * +d5.isAllLevelRecursive()+"; numLevel:"+d5.getNumLevel()); } catch
	 * (Exception e) { System.out.println("Should not see this!"+e); }
	 * System.out.println("\n\nTesting Exception throwing..."); System.out.print(
	 * "Creating TDirOption with isDirectory=true and allLevel=false... "); try {
	 * new TDirOption(true,false); System.out.println("Should not see this!"); }
	 * catch (InvalidTDirOptionAttributesException e) {
	 * System.out.println("OK creation failed as expected! "+e); }
	 * System.out.print(
	 * "Creating TDirOption with isDirectory=true and allLevel=true and numLevel>0... "
	 * ); try { new TDirOption(true,true,10);
	 * System.out.println("Should not see this!"); } catch
	 * (InvalidTDirOptionAttributesException e) {
	 * System.out.println("OK creation failed as expected! "+e); } }
	 */
}
