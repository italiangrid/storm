 ...
 */
/**
 * This class represents the TMetaDataPathDetail,return structure for ls request.
 *
 * @author Magnoni Luca
...
public class TMetaDataPathDetail {
  ...
  /** Method that get TMetaDataPathDetails @TODO */
  ...
  /**
   * Encode method, used to encode a TMetaDataPathDetail object into a structured paramter
   * (Hashtable), used for communicate to the FE component thourgh xmlrpc.
   *
