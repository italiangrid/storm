...
public class ArrayOfTSURLReturnStatus  {
    ...
    public void updateStatus(TSURLReturnStatus surlStatus, TReturnStatus newStatus) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException("Unable to update the status,null arguments: surlStatus="
                    + surlStatus + " newStatus=" + newStatus);
        }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (surlRetList == null)
        {
            ...
            if (!surlRetList.equals(other.surlRetList))
            {
                return false;
            }
        return true;
