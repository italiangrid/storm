...
public class TSURLLifetimeReturnStatus {
  ...
  /**
   * Add an element to 'outputVector'. The element is a HashMap structure of this instance of
   * TSURLLifetimeReturnStatus (used to communicate with the FE).
   * 
   * @param outputVector Vector
   */
  public void encode(List<Map<String, Object>> outputVector) {

    Map<String, Object> surlRetStatusParam = Maps.newHashMap();
    if (this.surl != null)
