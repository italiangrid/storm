...
public class TSURLLifetimeReturnStatus {
  ...
  public TSURLLifetimeReturnStatus(
    ...
    if (!ok) throw new InvalidTSURLLifetimeReturnStatusAttributeException(surl);
    this.surl = surl;
  ...
  /**
   * Add an element to 'outputVector'. The element is a Hashtable structure of this instance of
   * TSURLLifetimeReturnStatus (used to comunicate with the FE).
   *
