...
public class TRetentionPolicyInfo implements Serializable {
  ...
  public static final TRetentionPolicyInfo TAPE0_DISK1_RETENTION_POLICY =
      new TRetentionPolicyInfo(TRetentionPolicy.REPLICA, TAccessLatency.ONLINE);
  public static final TRetentionPolicyInfo TAPE1_DISK1_RETENTION_POLICY =
      new TRetentionPolicyInfo(TRetentionPolicy.CUSTODIAL, TAccessLatency.ONLINE);
  ...
  /**
   * decode() method creates a TRetentionPolicyInfo object from the information contained into the
   ...
   * @return
   */
  public static TRetentionPolicyInfo decode(Map<String, Object> inputParam, String fieldName) {

    Map<String, Object> param = (Map<String, Object>) inputParam.get(fieldName);
    if (param == null)
      return null;
    TRetentionPolicy retPol =
        TRetentionPolicy.decode(param, TRetentionPolicy.PNAME_retentionPolicy);
   ...
   * 
   * @param outputParam hashmap structure
   * @param fieldName field name
   */
