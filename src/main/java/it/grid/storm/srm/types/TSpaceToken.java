...
public class TSpaceToken implements Serializable {
  ...
  private static TSpaceToken emptyToken; // only instance of empty spaceToken
  ...
  /**
   * Factory method thta requires a String; if it is null, an InvalidTSpaceTokenAttributeException
   * is thrown.
   */
  ...
  /**
   * Decode method, used to represents this object into a structured parameter for FE communication.
   *
   * @param vector
   */
    ...
    if (tokenString != null) {
      ...
      try {
        spaceToken = TSpaceToken.make(tokenString);
          ...
          InvalidTSpaceTokenAttributesException e) {; // log.warn("Error creating TSpaceToken:"+e);
      }
    }
    return spaceToken;
  }
  ...
  /**
   * Encode method, used to represents this object into a structured parameter for FE communication.
   *
   * @param vector
   */
