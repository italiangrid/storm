...
public enum TRequestType {
  PREPARE_TO_GET("PrepareToGet"),
  PREPARE_TO_PUT("PrepareToPut"),
  COPY("Copy"),
  BRING_ON_LINE("BringOnLine"),
  EMPTY("Empty"),
  UNKNOWN("Unknown");
  ...
  /**
   * Facility method that returns a TRequestType object given its String representation. If no
   * TRequestType is found for the given String, an IllegalArgumentException is thrown.
   */
