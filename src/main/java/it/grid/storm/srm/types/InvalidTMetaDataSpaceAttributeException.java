...
/**
 * This class represents an Exception thrown when TMetaDataSpace retrince an
 * invalid constructor attributes.
 * 
 * @author Magnoni Luca
...
public class InvalidTMetaDataSpaceAttributeException extends Exception {
	...
	/**
	 * Constructor that requires the SizeUnit that aused the exception to be
	 * thrown.
	 */
