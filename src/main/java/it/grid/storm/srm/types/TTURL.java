...
public class TTURL {
  ...
  /**
   * Static method that requires the TransferProtocol and the TFN of this TURL: if any is null or
   * empty, an InvalidTURLAttributesException is thrown.
   */
  ...
  /**
   * Static factory method that returns a TTURL from a String representation: if it is null or
   * malformed then an InvalidTTURLAttributesException is thrown.
   */
  public static TTURL makeFromString(String s) throws InvalidTTURLAttributesException {
    ...
    try {
      ...
      log.warn("TTURL: Transfer protocol by {} is empty, but that's fine.", tpString);
    }
  ...
  /**
   * Method that returns the TransferProtocol of this TURL. If it is an empty TTURL, then an empty
   * TransferProtocol is returned.
   */
  ...
  /**
   * Method that returns the TFN of this TURL. If it is an empty TTURL, then an empty TFN is
   * returned.
   */
  public TFN tfn() {
