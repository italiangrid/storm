...
public class TRetentionPolicy {
  ...
  public static final TRetentionPolicy REPLICA = new TRetentionPolicy("REPLICA"),
      OUTPUT = new TRetentionPolicy("OUTPUT"),
      CUSTODIAL = new TRetentionPolicy("CUSTODIAL"),
      EMPTY = new TRetentionPolicy("EMPTY");
  ...
  public static final TRetentionPolicy getTRetentionPolicy(int idx) {
  ...
  /**
   * decode() method creates a TRetentionPolicy object from the inforation contained into the
   ...
   * @return
   */
  public static final TRetentionPolicy decode(Map inputParam, String fieldName) {
  ...
  public void encode(Map outputParam, String fieldName) {
    ...
    if (this.equals(TRetentionPolicy.REPLICA)) value = Integer.valueOf(0);
    if (this.equals(TRetentionPolicy.OUTPUT)) value = Integer.valueOf(1);
    if (this.equals(TRetentionPolicy.CUSTODIAL)) value = Integer.valueOf(2);
