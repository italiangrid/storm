...
public class TOverwriteMode {
  ...
  public static final TOverwriteMode WHENFILESAREDIFFERENT =
      new TOverwriteMode("WhenFilesAreDifferent");
  ...
  public static TOverwriteMode getTOverwriteMode(String mode) throws IllegalArgumentException {
    ...
    if (mode.equals(EMPTY.getValue())) return EMPTY;
    if (mode.equals(NEVER.getValue())) return NEVER;
    if (mode.equals(ALWAYS.getValue())) return ALWAYS;
    if (mode.equals(WHENFILESAREDIFFERENT.getValue())) return WHENFILESAREDIFFERENT;
