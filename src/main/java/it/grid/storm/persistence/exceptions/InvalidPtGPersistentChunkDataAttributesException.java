 ...
 * @version 2.0
 */
public class InvalidPtGPersistentChunkDataAttributesException
    extends InvalidPtGDataAttributesException {
   ...
   */
  public InvalidPtGPersistentChunkDataAttributesException(TRequestToken requestToken,
