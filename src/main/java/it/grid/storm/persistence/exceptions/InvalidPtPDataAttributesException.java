...
public class InvalidPtPDataAttributesException extends InvalidFileTransferDataAttributesException {
  ...
  public InvalidPtPDataAttributesException(TSURL toSURL, TLifeTimeInSeconds fileLifetime,
    ...
    init(spaceToken, fileLifetime, pinLifetime, fileStorageType, knownSizeOfThisFile,
        overwriteOption);
  }
  ...
  public InvalidPtPDataAttributesException(TSURL toSURL, TLifeTimeInSeconds fileLifetime,
      TLifeTimeInSeconds pinLifetime, TFileStorageType fileStorageType, TSpaceToken spaceToken,
      TSizeInBytes knownSizeOfThisFile, TURLPrefix transferProtocols,
      TOverwriteMode overwriteOption, TReturnStatus status, TTURL transferURL, String message) {
  ...
  public InvalidPtPDataAttributesException(TSURL toSURL, TLifeTimeInSeconds fileLifetime,
      TLifeTimeInSeconds pinLifetime, TFileStorageType fileStorageType, TSpaceToken spaceToken,
      TSizeInBytes knownSizeOfThisFile, TURLPrefix transferProtocols,
      TOverwriteMode overwriteOption, TReturnStatus status, TTURL transferURL, Throwable cause) {
