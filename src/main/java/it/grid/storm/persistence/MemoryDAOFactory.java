 ...
 * @version $Id: MemoryDAOFactory.java,v 1.3 2005/06/06 10:47:37 rzappi Exp $ $Revision: 1.3 $
 */
public class MemoryDAOFactory implements DAOFactory {
     ...
     * @todo Implement this it.grid.storm.catalog.persistence.CatalogFactory method
     */
    ...
    /**
     * Returns an implementation of StorageSpaceDAO, specific to a particular datastore.
     * 
     * @throws DataAccessException
