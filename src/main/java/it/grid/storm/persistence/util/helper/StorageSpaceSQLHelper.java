...
public class StorageSpaceSQLHelper extends SQLHelper {
  ...
  private static final HashMap<String, String> COLS = new HashMap<String, String>();
   ...
   * @throws SQLException
   */
  public PreparedStatement selectBySpaceAliasQuery(
      Connection conn, GridUserInterface user, String spaceAlias) throws SQLException {
  ...
  public PreparedStatement selectByPreviousOrNullLastUpdateQuery(
    ...
    str =
        "SELECT * FROM storage_space where "
            + COLS.get("update_time")
            + " IS NULL or UNIX_TIMESTAMP("
            + COLS.get("update_time")
            + ") < ?";
   ...
   * @throws SQLException
   */
  public PreparedStatement removeByTokenQuery(
      Connection conn, GridUserInterface user, String spaceToken) throws SQLException {
   ...
   * @throws SQLException
   */
  public PreparedStatement updateFreeSpaceByTokenQuery(
      Connection conn, String token, long freeSpace, Date updateTimestamp) throws SQLException {
  ...
  public PreparedStatement increaseUsedSpaceByTokenQuery(
      Connection conn, String token, long usedSpaceToAdd) throws SQLException {
  ...
  public PreparedStatement decreaseUsedSpaceByTokenQuery(
      Connection conn, String token, long usedSpaceToRemove) throws SQLException {
