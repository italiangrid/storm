...
/**
 * This class represents a PrepareToPutChunkData, that is part of a multifile PrepareToPut srm
 * request. It contains data about: the requestToken, the toSURL, the requested lifeTime of pinning,
 * the requested lifetime of volatile, the requested fileStorageType and any available spaceToken,
 * the expectedFileSize, the desired transferProtocols in order of preference, the overwriteOption
 * to be applied in case the file already exists, the transferURL for the supplied SURL.
 * 
...
public class PtPPersistentChunkData extends IdentityPtPData implements PersistentChunkData {
  ...
  private static final Logger log = LoggerFactory.getLogger(PtPPersistentChunkData.class);
  ...
  public PtPPersistentChunkData(GridUserInterface auth, TRequestToken requestToken, TSURL toSURL,
      ...
      TTURL transferURL)
      throws InvalidPtPPersistentChunkDataAttributesException, InvalidPtPDataAttributesException,
