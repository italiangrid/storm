...
/**
 * Class that represents some of the fileds in a row in the Persistence Layer: this is all raw data
 * referring to the ReducedPtGChunkData proper, that is String and primitive types.
 * 
 * @author EGRID ICTP
 * @version 1.0
 * @date November, 2006
...
public class ReducedPtGChunkDataTO {
  ...
  private int status = StatusCodeConverter.getInstance().toDB(SRM_REQUEST_QUEUED);
