...
import it.grid.storm.persistence.exceptions.InvalidBoLPersistentChunkDataAttributesException;
...
public class BoLPersistentChunkData extends BoLData implements PersistentChunkData {
  ...
  public BoLPersistentChunkData(TRequestToken requestToken, TSURL fromSURL,
      TLifeTimeInSeconds lifeTime, TDirOption dirOption, TURLPrefix desiredProtocols,
      TSizeInBytes fileSize, TReturnStatus status, TTURL transferURL, int deferredStartTime)
      throws InvalidBoLPersistentChunkDataAttributesException,
      InvalidFileTransferDataAttributesException, InvalidBoLDataAttributesException,
    ...
    if (requestToken == null) {
      ...
      throw new InvalidBoLPersistentChunkDataAttributesException(requestToken, fromSURL, lifeTime,
