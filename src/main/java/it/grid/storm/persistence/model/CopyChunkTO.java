...
/**
 * holds all info necessary to complete a srmCopy of a single file, and to
 * report advancement status of this part of the request. Data supplied to the
...
public class CopyChunkTO {
	...
	/**
	 * public TRequestId getRequestId(); public StoRI getFromSURL(); public StoRI
	 * getToSURL(); public String getStorageSystemInfo(); public TDirOption
	 * getDirOption(); public TOverwriteMode getOverwriteMode(); public
	 ...
	 * 
	 * public TSizeInBytes getFileSize(); public TSizeInBytes setFileSize(final
	 * size_t size);
	 * 
	 * public TReturnStatus getStatus(); public int setStatus(final TStatusCode
	 * code, final String explanation);
	 * 
