...
/**
 * This class represents the SummaryData associated with the SRM request, that is it contains info
 * about: TRequestToken, TRequsetType, total files in this request, number of files in queue, number
 * of files progressing, number of files finished, and whether the request is currently suspended.
 *
...
public class RequestSummaryTO {
  ...
  public RequestSummaryTO(
    ...
    boolean ok =
        requestToken != null
            ...
            && numFinished >= 0;
    if (!ok)
      throw new InvalidRequestSummaryDataAttributesException(
          requestToken,
          requestType,
  ...
  /** Method that returns the number of files in the SRM request that are currently in queue. */
  ...
  /**
   * Method used to increment the counter for the processing of files that are currently finished.
   */
  ...
  /**
   * Method used to decrement the counter that keeps track of the number of files that are currently
   * finished.
   */
  ...
  /**
   * Method used to set the SRM flag that signals the processing of the request this
   * RequestSummaryData applies to, is suspended.
   */
  ...
  /**
   * Method used to set the SRM flag that signals the procesing of the request this
   * RequestSummaryData applies to, is _not_ suspended
   */
