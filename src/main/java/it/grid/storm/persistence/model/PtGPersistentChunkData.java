...
import it.grid.storm.persistence.exceptions.InvalidPtGPersistentChunkDataAttributesException;
...
public class PtGPersistentChunkData extends IdentityPtGData implements PersistentChunkData {
  ...
  /**
   * long representing the primary key for the persistence layer, in the status_Get table
   */
   ...
   */
  public PtGPersistentChunkData(GridUserInterface auth, TRequestToken requestToken, TSURL fromSURL,
      TLifeTimeInSeconds lifeTime, TDirOption dirOption, TURLPrefix desiredProtocols,
      TSizeInBytes fileSize, TReturnStatus status, TTURL transferURL)
      throws InvalidPtGDataAttributesException, InvalidPtGDataAttributesException,
