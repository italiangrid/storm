...
public class PtPChunkDataTO {
  ...
  private String fileStorageType = null; // initialized in constructor
  private String spaceToken = " ";
  private List<String> protocolList = null; // initialized in constructor
  private String overwriteOption = null; // initialized in constructor
  private int status; // initialized in constructor
  ...
  public PtPChunkDataTO() {
    ...
    this.overwriteOption = OverwriteModeConverter.toDB(TOverwriteMode.NEVER);
