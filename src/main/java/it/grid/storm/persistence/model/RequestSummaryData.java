...
public class RequestSummaryData {
	...
	public RequestSummaryData(TRequestType rtype, TRequestToken rtoken,
		GridUserInterface gu) throws InvalidRequestSummaryDataAttributesException {

		boolean ok = rtype != null && rtoken != null && gu != null;
		if (!ok)
			throw new InvalidRequestSummaryDataAttributesException(rtype, rtoken, gu);
	...
	/**
	 * Method that returns a long corresponding to the identifier of This object
	 * in persistence.
	 */
	...
	/**
	 * Method used to set the log corresponding to the identifier of This object
	 * in persistence.
	 */
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
			+ ((deferredStartTime == null) ? 0 : deferredStartTime.hashCode());
		result = prime * result + ((errstring == null) ? 0 : errstring.hashCode());
		result = prime * result
			+ ((fileLifetime == null) ? 0 : fileLifetime.hashCode());
		result = prime * result + ((gu == null) ? 0 : gu.hashCode());
		result = prime * result + (int) (id ^ (id >>> 32));
		result = prime * result
			+ ((nbreqfiles == null) ? 0 : nbreqfiles.hashCode());
		result = prime * result
			+ ((numOfCompleted == null) ? 0 : numOfCompleted.hashCode());
		result = prime * result
			+ ((numOfFailed == null) ? 0 : numOfFailed.hashCode());
		result = prime * result
			+ ((numOfWaiting == null) ? 0 : numOfWaiting.hashCode());
		result = prime * result
			+ ((pinLifetime == null) ? 0 : pinLifetime.hashCode());
		result = prime
			* result
			+ ((remainingDeferredStartTime == null) ? 0 : remainingDeferredStartTime
				.hashCode());
		result = prime * result
			+ ((remainingTotalTime == null) ? 0 : remainingTotalTime.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		} else if (!remainingDeferredStartTime
			.equals(other.remainingDeferredStartTime)) {
			return false;
		}
