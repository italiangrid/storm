...
public class AnonymousPtPData extends AnonymousFileTransferData implements PtPData {
  ...
  public AnonymousPtPData(TSURL toSURL, TLifeTimeInSeconds pinLifetime,
      ...
      TReturnStatus status, TTURL transferURL) throws InvalidPtPDataAttributesException,
    ...
    if (pinLifetime == null || fileLifetime == null || spaceToken == null || fileStorageType == null
      ...
      log.debug(
          "Invalid arguments: pinLifetime={}, fileLifetime={}, "
              + "spaceToken={}, fileStorageType={}, expectedFileSize={}, " + "overwriteOption={}",
          pinLifetime, fileLifetime, spaceToken, fileStorageType, expectedFileSize,
          overwriteOption);
  ...
  public boolean equals(Object o) {
    ...
    return SURL.equals(cd.SURL) && pinLifetime.equals(cd.pinLifetime)
        && fileLifetime.equals(cd.fileLifetime) && fileStorageType.equals(cd.fileStorageType)
        && spaceToken.equals(cd.spaceToken) && expectedFileSize.equals(cd.expectedFileSize)
