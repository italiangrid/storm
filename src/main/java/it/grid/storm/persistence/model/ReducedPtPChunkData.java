 ...
 * multifile PrepareToPut srm request. It is closely related to PtPChunkData but
 * it is called Reduced because it only contains the toSURL, the current
 ...
 * 
 * This class is intended to be used by srmPutDone, where only a limited amount
 * of information is needed instead of full blown PtPChunkData. It is also used
 * by the automatic handlnig of non invoked srmPutDone, during transition to
...
public class ReducedPtPChunkData {
	...
	private static final Logger log = LoggerFactory
		.getLogger(ReducedPtPChunkData.class);
	...
	public ReducedPtPChunkData(TSURL toSURL, TReturnStatus status,
		...
		if (status == null || toSURL == null || fileStorageType == null
			|| fileLifetime == null) {
	...
	/**
	 * Method that returns the fileLifetime of the srm request to which this chunk
	 * belongs.
	 */
	...
	public boolean equals(Object o) {
		...
		return (primaryKey == cd.primaryKey) && toSURL.equals(cd.toSURL)
			&& status.equals(cd.status) && fileStorageType.equals(cd.fileStorageType)
