 ...
 * @version 3.0
 */
public class AnonymousPtGData extends AnonymousFileTransferData implements PtGData {
   ...
   */
  public AnonymousPtGData(TSURL SURL, TLifeTimeInSeconds lifeTime, TDirOption dirOption,
    ...
    if (lifeTime == null || dirOption == null || fileSize == null) {
      log.debug("Invalid arguments: lifeTime={}, dirOption={}, fileSize={}", lifeTime, dirOption,
          fileSize);
   ...
   * (non-Javadoc)
   * 
   * @see it.grid.storm.catalogs.PtGData#setFileSize(it.grid.storm.srm.types.TSizeInBytes )
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see it.grid.storm.catalogs.PtGData#changeStatusSRM_FILE_PINNED(java.lang.String )
   */
  @Override
