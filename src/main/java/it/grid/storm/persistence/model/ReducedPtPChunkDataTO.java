 ...
 * referring to the ReducedPtPChunkData proper, that is String and primitive types.
 * 
 * @author EGRID ICTP
 * @version 1.0
 * @date January, 2007
...
public class ReducedPtPChunkDataTO {
  ...
  private String fileStorageType = FileStorageTypeConverter.getInstance().toDB(VOLATILE);
