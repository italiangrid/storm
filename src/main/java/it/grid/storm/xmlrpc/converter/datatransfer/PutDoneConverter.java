 ...
 */
/**
 * This class represents the Type Converter for PutDone function. This class receives input datas
 * from xmlrpc call and converts these datas into a StoRM Type that can be used to invoke the
 * PutDoneManager.
 *
...
public class PutDoneConverter extends ManageFileTransferConverter implements Converter {
  ...
  /**
   * This method returns a PutDoneInputData created from the input Hashtable structure of an xmlrpc
   * PutDone v2.2 call.
   *
