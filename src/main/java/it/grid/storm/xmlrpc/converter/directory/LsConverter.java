 ...
 * <p>
 * 
 * This class represents the Type Converter for LS function . This class have get an input data from
 * xmlrpc call anc convert it into a StoRM Type that can be used to invoke the LSManager
 * 
 * 
 * Authors:
 * 
...
public class LsConverter implements Converter {
  ...
  public InputData convertToInputData(Map<String, Object> inputParam) {
    ...
    if (guser != null) {
      inputData = new IdentityLSInputData(guser, surlArray, fileStorageType, fullDL, allLR, numOL,
          offset, count);
    } else {
      inputData =
