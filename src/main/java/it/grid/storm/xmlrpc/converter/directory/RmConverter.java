 ...
 *
 * <p>This class represents the Type Converter for Rm function . This class have get an input data
 * from xmlrpc call anc convert it into a StoRM Type that can be used to invoke the RmManager
 *
...
public class RmConverter implements Converter {
  ...
  public InputData convertToInputData(Map inputParam) {
    ...
    log.debug(
        "RmConverter: Input Structure toString: {}", ParameterDisplayHelper.display(inputParam));
