 ...
 *
 * <p>This class represents the Type Converter for Rmdir function . This class have get an input
...
public class RmdirConverter implements Converter {
  ...
  public InputData convertToInputData(Map inputParam) {
    ...
    log.debug(
        "srmRmdir: Converter :Call received :Creation of RmdirInputData = {}", inputParam.size());
    log.debug(
        "srmRmdir: Converter: Input Structure toString: {}",
    ...
    Boolean recursive =
        inputParam.get(member_recursive) == null
            ? false
