...
/**
 * This class represents the Type Converter for Rmdir function . This class have get an input data
 * from xmlrpc call anc convert it into a StoRM Type that can be used to invoke the RmdirManager
 */
...
public class RmdirConverter implements Converter {
  ...
  /**
   * This method return a RmdirInputData created from input Hashtable structure of an xmlrpc Rmdir
   * v2.1 call. Rmdir Input Data can be used to invoke mkdir method of DirectoryFunctionsManager
   */
  public InputData convertToInputData(Map<String, Object> inputParam) {

    log.debug("srmRmdir: Converter :Call received :Creation of RmdirInputData = {}",
        inputParam.size());
   ...
   * (non-Javadoc)
   * 
   * @see it.grid.storm.xmlrpc.converter.Converter#convertFromOutputData(it.grid.
