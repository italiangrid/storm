 ...
 */
/**
 * This class represents the Type Converter for AbortRequest function. This class receives input
 * datas from xmlrpc call and converts these datas into a StoRM Type that can be used to invoke the
 * AbortManager.
 *
 * @author Magnoni Luca
