...
public class TapeRecallDAOProperties extends TapeRecallDAO {
	...
	private static final Logger log = LoggerFactory
		.getLogger(TapeRecallDAOProperties.class);
	...
	// */
	// @Override
	// public List<TapeRecallTO> getInProgressTask(String voName) throws
	// DataAccessException {
	// tasks = getTasks();
	...
	// if ((voName.equals(UNSPECIFIED)) ||
	// (TapeRecallTO.getVoName().equals(voName))) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.grid.storm.persistence.dao.TapeRecallDAO#getNumberInProgress(java.
	 * lang.String)
	 */
	// @Override
	...
	// */
	// @Override
	// public int getNumberOfTasksWithStatus(RecallTaskStatus status, String
	// voName) throws DataAccessException {
	// if (voName == null) {
	// voName = UNSPECIFIED;
	// }
	// tasks = getTasks();
	...
	// for (TapeRecallTO TapeRecallTO : tasks.values()) {
	// if ((TapeRecallTO.getRecallStatus().equals(RecallTaskStatus.IN_PROGRESS))
	// || ((TapeRecallTO.getRecallStatus().equals(RecallTaskStatus.QUEUED)))) {
	// result.add(TapeRecallTO);
	// }
	//
	// }
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.grid.storm.persistence.dao.TapeRecallDAO#getNumberQueued(java.lang
	 * .String)
	 */
	// @Override
	...
	// */
	// @Override
	// public int getRetryValue(UUID taskId, String requestToken) throws
	// DataAccessException {
	// int result = 0;
	// tasks = getTasks();
	// if (!(tasks.isEmpty())) {
	...
	//
	// @Override
	// public UUID getTaskId(String requestToken, String pfn) throws
	// DataAccessException {
	// // TODO Auto-generated method stub
	...
	// */
	// @Override
	// public int getTaskStatus(UUID taskId, String requestToken) throws
	// DataAccessException {
	...
	// } else {
	// throw new DataAccessException("Recall Task with taskId = " + taskId +
	// " does not exists!");
	// }
	// return result;
	// }
	 ...
	 */
	// @Override
	// public void purgeCompletedTasks(int numMaxToPurge) throws
	// DataAccessException {
	// ArrayList<TapeRecallTO> ordTasks = getOrderedTasks();
	// ArrayList<TapeRecallTO> result = new ArrayList<TapeRecallTO>();
	// if (!(tasks.isEmpty())) {
	// for (TapeRecallTO TapeRecallTO : ordTasks) {
	// if ((TapeRecallTO.getRecallStatus().equals(TapeRecallStatus.ERROR)) ||
	// ((TapeRecallTO.getRecallStatus().equals(TapeRecallStatus.ABORTED))) ||
	// ((TapeRecallTO.getRecallStatus().equals(TapeRecallStatus.SUCCESS)))) {
	// result.add(TapeRecallTO);
	// }
	// }
	// int count = 0;
	...
	// */
	// @Override
	// public void setRetryValue(UUID taskId, String requestToken, int value)
	// throws DataAccessException {
	// ArrayList<TapeRecallTO> tasks = new
	// ArrayList<TapeRecallTO>(getTask(taskId));
	// if (!(tasks.isEmpty())) {
	...
	/*
	 * // * (non-Javadoc) // * // * @see
	 * it.grid.storm.persistence.dao.TapeRecallDAO#takeoverTasks(int) //
	 */
	// @Override
	// public List<TapeRecallTO> takeoverTasks(int numberOfTaks) throws
	// DataAccessException {
	...
	// if ((TapeRecallTO.getVoName().equals(voName)) ||
	// (voName.equals(UNSPECIFIED))) {
	...
	// }
	// if (residualTasks > 0) {
	// throw new DataAccessException("Not enough tasks belonging to VO : " +
	// voName + " to takeover. Residual tasks = " + residualTasks);
	// }
	//
	...
	// private ArrayList<TapeRecallTO> getOrderedTasks() throws
	// DataAccessException {
	// tasks = getTasks();
	// ArrayList<TapeRecallTO> result = new
	// ArrayList<TapeRecallTO>(tasks.values());
	// return result;
	// }

	// private LinkedHashMap<TRequestToken, TapeRecallTO> getTasks() throws
	// DataAccessException {
	// getTasksDB();
	...
	// */
	// @Override
	// protected boolean setTaskStatusDBImpl(UUID taskId, String requestToken, int
	// status) throws DataAccessException {
	...
	// @Override
	// public Integer setGroupTaskID(UUID taskId, Set<TRequestToken>
	// requestTokens, UUID groupTaskID) throws DataAccessException
	// {
	// // TODO Auto-generated method stub
	// return null;
	// }
	...
	// @Override
	// public List<TapeRecallTO> getGroupTasks(UUID groupTaskId) throws
	// DataAccessException
	// {
	// // TODO Auto-generated method stub
	// return null;
	...
	//
	// @Override
	// public List<String> getRequestToken(UUID taskId, int status) throws
	// DataAccessException {
	// // TODO Auto-generated method stub
	// return null;
	// }
	...
	// @Override
	// public Integer setGroupTaskID(UUID taskId, Set<String> requestTokens, UUID
	// groupTaskID) throws DataAccessException {
	// // TODO Auto-generated method stub
	// return null;
	// }
	//
	...
	//
	// @Override
	// public List<TapeRecallTO> getTask(UUID taskId, int[] statuses) throws
	// DataAccessException {
	// // TODO Auto-generated method stub
	// return null;
	// }
	...
	@Override
	public boolean setGroupTaskStatus(UUID groupTaskId, int statusId,
