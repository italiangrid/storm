...
@Provider
@Produces("text/plain")
public class TapeRecallTOListMessageBodyWriter implements MessageBodyWriter<List<TapeRecallTO>> {
  ...
  public boolean isWriteable(
    ...
    if (List.class.isAssignableFrom(type) && genericType instanceof ParameterizedType) {
      ...
      isWritable = (actualTypeArgs.length == 1 && actualTypeArgs[0].equals(TapeRecallTO.class));
