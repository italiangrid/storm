...
public final class Strings {
	 ...
	 *          The second operand
	 * 
	 * @return true if both are null or both are non-null and the same string
	 *         value
	 */
	...
	/**
	 * Removes preceding or proceeding whitespace from a string or return null if
	 * the string is null or of zero length after trimming (i.e. if the string
