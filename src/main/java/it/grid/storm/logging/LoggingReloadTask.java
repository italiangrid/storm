...
public class LoggingReloadTask extends TimerTask {
	 ...
	 *          path to the logging configuration file to watch for changes and
	 *          reload.
	 */
	...
	public void run() {
		...
		try {
			...
			List<ch.qos.logback.classic.Logger> listLogger = loggerContext
				.getLoggerList();
			...
			log.info("Loaded new logging configuration file {}",
				loggingConfigFile.getAbsoluteFile());
