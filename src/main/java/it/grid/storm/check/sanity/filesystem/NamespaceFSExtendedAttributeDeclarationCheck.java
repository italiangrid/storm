...
public class NamespaceFSExtendedAttributeDeclarationCheck implements Check {
	...
	private static final Logger log = LoggerFactory
		.getLogger(NamespaceFSExtendedAttributeDeclarationCheck.class);
	...
	/**
	 * Checks if the ext3 mount option POSIX_EXTENDED_ATTRIBUTES_OPTION_NAME is in
	 * the provided mount options list
	 * 
	 * @param fsOptions
