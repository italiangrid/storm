...
public enum SupportedFSType {
	 ...
	 *           if the provided fsString does not match any SupportedFSType
	 */
	public static SupportedFSType parseFS(String fsString)
		throws IllegalArgumentException {
		...
		throw new IllegalArgumentException("Unable to parse file system string \'"
			+ fsString + "\' No matching value available");
	}
}
