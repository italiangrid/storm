...
public interface Check {
   ...
   * Executes the check
   *
   * @return a successful CheckResponse if the check succeeds, a non successful with an error
   *     message otherwise
   * @throws GenericCheckException if an error occurs during check execution that prevents check
   *     execution
   */
