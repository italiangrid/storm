 ...
 * srmPrepareToGet statements. It chops a multifile request, and for each part
 * it checks whether the dir option is set and expands the directory as
 * necessary.
 * 
 ...
 * accept the chunk for any reason, a messagge with the requestToken and the
...
public final class PtGFeeder implements Delegable {
	 ...
	 */
	public PtGFeeder(RequestSummaryData rsd)
		throws InvalidPtGFeederAttributesException {
	 ...
	 * ones; it then creates the necessary tasks and loads them into the PtG chunk
	 * scheduler.
	 */
	public void doIt() {
	...
	/**
	 * Private method that handles the case of a PtGChunkData having dirOption
	 * set!
	 * 
	 * @param chunkData
	 */
