...
public class SRMClientFactory {
	...
	final private static SRMClientFactory factory = new SRMClientFactory(); // only
																																					// instance
																																					// of
	...
	/**
	 * Method that returns a new instance of an SRMClient. If the configured class
	 * cannot be supplied, a NoSRMClientFoundException is thrown.
	 */
