 ...
 * @date september, 2005
 */
public abstract class CopyPersistentChunk extends Copy implements
	PersistentRequestChunk {
	...
	public CopyPersistentChunk(GridUserInterface gu, RequestSummaryData rsd,
		...
		if (rsd == null || gsm == null) {
			throw new InvalidCopyPersistentChunkAttributesException(gu, rsd,
				requestData, n, gsm);
		}
		this.rsd = rsd;
		this.gsm = gsm;
	...
	public String getName() {
		...
		return "RequestToken of srmCopy: "
			+ ((CopyPersistentChunkData) requestData).getRequestToken();
	}
	...
	public void persistStatus() {
		...
		CopyChunkCatalog.getInstance()
			.update((CopyPersistentChunkData) requestData);
	}
