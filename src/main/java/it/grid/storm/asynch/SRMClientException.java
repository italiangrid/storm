...
public class SRMClientException extends Exception {
	...
	private String explanation = ""; // String that explains what went wrong with
																		// srm client operation
	...
	/**
	 * Public constructor that requires the String explaining the reason for the
	 * srm failure.
	 */
