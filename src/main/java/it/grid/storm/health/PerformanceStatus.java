...
public class PerformanceStatus {
  ...
  private Hashtable<OperationType, PerformanceEvent> perfStatus =
      new Hashtable<OperationType, PerformanceEvent>();
  private static long timeWindows = HealthMonitor.getInstance().getPeriod();
