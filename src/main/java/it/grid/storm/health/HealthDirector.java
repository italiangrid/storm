...
public class HealthDirector {
  ...
  public static final Logger LOGGER = StoRMLoggers.getHBLogger();
	...
	private static boolean bookKeepingEnabled;
...
//
//	public static void initializeDirector(Configuration config) {
//
//	  bookKeepingEnabled = config.isHearthbeatBookkeepingEnabled();
//	  timeToLiveLogEventInSec = config.getPerformanceLogbookTimeInterval();
//
