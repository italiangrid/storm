...
public interface AclManagementInterface
{
     ...
     * @param permission
     */
    void grantGroupPermission(LocalFile localFile, LocalUser localUser, FilesystemPermission permission);
     ...
     * @param permission
     */
    void grantUserPermission(LocalFile localFile, LocalUser localUser, FilesystemPermission permission);
     ...
     * @param permission
     */
    void revokeGroupPermission(LocalFile localFile, LocalUser localUser, FilesystemPermission permission);
     ...
     * @param permission
     */
    void revokeUserPermission(LocalFile localFile, LocalUser localUser, FilesystemPermission permission);
     ...
     * @param permission
     */
    void setGroupPermission(LocalFile localFile, LocalUser localUser, FilesystemPermission permission);
    ...
    /**
     * Moves all the permission from any user/group from the provided fromLocalFile to the new toLocalFile 
     * (NOTE: can be assumed that toLocalFile has no ACL)  
     * 
     * @param fromLocalFile
     * @param toLocalFile
     */
