...
public class AclManagerFSAndHTTPS implements AclManager {
	 ...
	 * 
	 * @see
	 * it.grid.storm.acl.AclManager#grantGroupPermission(it.grid.storm.griduser
	 * .LocalUser, it.grid.storm.filesystem.FilesystemPermission)
	 */
	@Override
	public FilesystemPermission grantGroupPermission(LocalFile localFile,
		LocalUser localUser, FilesystemPermission permission)
	 ...
	 * 
	 * @see
	 * it.grid.storm.acl.AclManager#grantUserPermission(it.grid.storm.filesystem
	 * .LocalFile, it.grid.storm.griduser.LocalUser,
	 * it.grid.storm.filesystem.FilesystemPermission)
	 */
	@Override
	public FilesystemPermission grantUserPermission(LocalFile localFile,
		LocalUser localUser, FilesystemPermission permission)
		throws IllegalArgumentException {
	...
	@Override
	public FilesystemPermission removeGroupPermission(LocalFile localFile,
		LocalUser localUser) throws IllegalArgumentException {
	...
	@Override
	public FilesystemPermission removeUserPermission(LocalFile localFile,
		LocalUser localUser) throws IllegalArgumentException {
	...
	@Override
	public FilesystemPermission revokeGroupPermission(LocalFile localFile,
		LocalUser localUser, FilesystemPermission permission)
		throws IllegalArgumentException {
	...
	@Override
	public FilesystemPermission revokeUserPermission(LocalFile localFile,
		LocalUser localUser, FilesystemPermission permission)
		throws IllegalArgumentException {
	...
	@Override
	public FilesystemPermission setGroupPermission(LocalFile localFile,
		LocalUser localUser, FilesystemPermission permission)
		throws IllegalArgumentException {
	...
	@Override
	public FilesystemPermission setUserPermission(LocalFile localFile,
		LocalUser localUser, FilesystemPermission permission)
		throws IllegalArgumentException {
	...
	@Override
	public void grantHttpsUserPermission(LocalFile localFile,
		LocalUser localUser, FilesystemPermission permission)
		throws IllegalArgumentException {
	...
	@Override
	public void grantHttpsGroupPermission(LocalFile localFile,
		LocalUser localUser, FilesystemPermission permission)
		throws IllegalArgumentException {
	...
	@Override
	public void moveHttpsPermissions(LocalFile fromLocalFile,
		LocalFile toLocalFile) throws IllegalArgumentException {
