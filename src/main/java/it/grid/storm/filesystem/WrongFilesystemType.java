...
/**
 * Thrown by genericfs subclasses ctors when the filesystem the passed pathname
 * resides on, is not of a type supported by the class.
 * 
 * Corresponds in usage to fs::wrong_filesystem_type exception thrown by C++
 * filesystem code.
 * 
