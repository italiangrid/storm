 ...
 *     <p>Source code for class WrongFilesystemType
 */
/*
...
/**
 * Thrown by genericfs subclasses ctors when the filesystem the passed pathname resides on, is not
 * of a type supported by the class.
 *
 * <p>Corresponds in usage to fs::wrong_filesystem_type exception thrown by C++ filesystem code.
 *
 * @see fs::wrong_filesystem_type
 * @author Riccardo Murri <riccardo.murri@ictp.it>
 * @version $Revision: 1.1 $
 */
public class WrongFilesystemType extends FilesystemError {
