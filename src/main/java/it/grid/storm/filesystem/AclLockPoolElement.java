 ...
 *     <p>The it.grid.storm.filesystem.AclLockPoolElement class
 */
/*
 ...
 *
 * <p>Each {@link #incrementUsageCountAndReturnSelf()} request increments the usage counter, and
 * each {@link #decrementUsageCountAndGetIt()} request decrements it.
 *
 * @author Riccardo Murri <riccardo.murri@ictp.it>
