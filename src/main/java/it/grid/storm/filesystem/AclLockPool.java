 ...
 * zero.
 * 
 * <p> This class' purpose is to provide a shared storage for lock objects used
 * by the {@link it.grid.storm.filesystem.File} class.
 * 
...
class AclLockPool {
   ...
   * default load factor and concurrencyLevel (from {@link
  ...
  synchronized public AclLockPoolElement get(final String pathname) {
    ...
    if (!__map.containsKey(pathname))
      __map.put(pathname, new AclLockPoolElement());
