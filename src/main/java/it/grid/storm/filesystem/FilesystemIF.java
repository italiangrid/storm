...
public interface FilesystemIF {
   ...
   * 
   * - else if the requestor's UID matches a UID in a <em>specific user</em>
   * entry, then the bitwise-AND of that entry's permissions and the @em mask
   * entry permissions are used;
   * 
   * - else if any of the requestor's GIDs (primary or supplementary) matches
   * the group owner entry, the bitwise-AND of that entry's permissions and
   * the @em mask entry permissions are used;
   * 
   * - else if any of the requestor's GIDs (primary or supplementary) matches
   * the group owner entry, the bitwise-AND of that entry's permissions and
   * the @em mask entry permissions are used;
   ...
   */
  boolean canAccess(LocalUser u, String fileOrDirectory,
   ...
   * associated with the primary group of the given {@link
   * it.grid.storm.griduser.LocalUser} instance <i>u</i>. If no entry for that
   * group is found, return <code>null</code>.
   * 
   * @param u the local user ({@link it.grid.storm.griduser.LocalUser} instance)
   * whose primary GID's permissions are to be retrieved.
   * 
   * @param fileOrDirectory pathname to the file or directory whose ACL is to be
   * searched for the named group permissions.
   * 
   * @return permission associated to the primary GID of the given {@link
   * it.grid.storm.griduser.LocalUser} instance <i>u</i> in the given file ACL,
   * or <code>null</code> if no entry for that group was found.
   */

  FilesystemPermission getEffectiveGroupPermission(LocalUser u,
   ...
   * 
   * Loads the ACL for the given file or directory, and return the permission
   * associated with the UID of the given {@link
   * it.grid.storm.griduser.LocalUser} instance <i>u</i>. If no entry for that
   * user is found, return <code>null</code>.
   * 
   * @param u the local user ({@link it.grid.storm.griduser.LocalUser} instance)
   * whose permissions are to be retrieved.
   * 
   * @param fileOrDirectory pathname to the file or directory whose ACL is to be
   * searched for the given user permissions.
   * 
   * @return permission associated to the UID of the given {@link LocalUser}
   * instance <i>u</i> in the given file ACL, or <code>null</code> if no entry
   * for that user was found.
   */

  FilesystemPermission getEffectiveUserPermission(LocalUser u,
    String fileOrDirectory);
   ...
   * 
   * <p> Adds the specified permission to the ones that the primary group of the
   ...
   * ACL.
   * 
   * <p> If no entry is present for the specified group, then one is created and
   * its permission value is set to <i>permission</i>.
   * 
   * @param u the local user ({@link it.grid.storm.griduser.LocalUser} instance)
   * whose primary GID's entry is to be altered.
   * 
   * @param fileOrDirectory pathname to the file or directory whose ACL is to be
   * searched for the given group permissions
   * 
   * @param permission Capabilities to grant.
   * 
   * @return permission formerly associated to the primary GID of the given
   * {@link it.grid.storm.griduser.LocalUser} instance <i>u</i> in the given
   * file ACL, or <code>null</code> if no entry for that group was found.
   * 
   * @see fs_acl::grant_group_perm()
   */

  FilesystemPermission grantGroupPermission(LocalUser u, String fileOrDirectory,
   ...
   * former permission.
   * 
   * <p> Adds the specified permissions to the ones that the UID of the given
   ...
   * ACL.
   * 
   * <p> If no entry is present for the specified user, then one is created and
   * its permission value is set to <i>permission</i>.
   * 
   * @param u the local user ({@link it.grid.storm.griduser.LocalUser} instance)
   ...
   * it.grid.storm.griduser.LocalUser} instance <i>u</i> in the given file ACL,
   * or <code>null</code> if no entry for that user was found.
   * 
   * @see fs_acl::grant_user_perm()
   */

  FilesystemPermission grantUserPermission(LocalUser u, String fileOrDirectory,
    FilesystemPermission permission);
   ...
   * it.grid.storm.griduser.LocalUser} instance <i>u</i> from the given file or
   ...
   * owning group, then its entry is set to {@link #NONE}, rather than removed.
   * 
   * @param u the local user ({@link it.grid.storm.griduser.LocalUser} instance)
   * whose primary GID's entry is to be altered.
   * 
  ...
  FilesystemPermission removeGroupPermission(LocalUser u,
    String fileOrDirectory);
   ...
   * 
   * @param fileOrDirectory pathname to the file or directory whose ACL is to be
   * searched for the named user permissions
   * 
   * @return permission formerly associated to the UID of the given {@link
   * it.grid.storm.griduser.LocalUser} instance <i>u</i> in the given file ACL,
   * or <code>null</code> if no entry for that user was found.
  ...
  FilesystemPermission removeUserPermission(LocalUser u,
    String fileOrDirectory);
   ...
   * 
   * <p> Removes the specified permission from the ones that the primary group
   * of the given {@link it.grid.storm.griduser.LocalUser} instance <i>u</i>
   ...
   * 
   * <p> If no entry is present for the specified group, then one is created and
   * its permission value is set to {@link #NONE}.
   * 
   * @param u the local user ({@link it.grid.storm.griduser.LocalUser} instance)
   * whose primary GID's entry is to be altered.
   * 
  ...
  FilesystemPermission revokeGroupPermission(LocalUser u,
   ...
   * 
   * <p> Removes the specified permission from the ones that the primary user of
  ...
  FilesystemPermission revokeUserPermission(LocalUser u, String fileOrDirectory,
    FilesystemPermission permission);
   ...
   * return the former permission.
   * 
   * <p> Sets the entry of the primary group of the given {@link LocalUser}
   * instance <i>u</i> to the given <i>permission</i>. Returns the permission
   * formerly associated with that group.
   * 
   * @param u the local user ({@link it.grid.storm.griduser.LocalUser} instance)
   * whose primary GID's entry is to be altered.
   * 
  ...
  FilesystemPermission setGroupPermission(LocalUser u, String fileOrDirectory,
    FilesystemPermission permission);
   ...
   * return the former permission.
   * 
   * <p> Sets the entry of the primary user of the given {@link LocalUser}
   * instance <i>u</i> to the given <i>permission</i>. Returns the permission
   * formerly associated with that user.
   * 
   * @param u the local user ({@link it.grid.storm.griduser.LocalUser} instance)
   * whose UID's entry is to be altered.
   * 
  ...
  FilesystemPermission setUserPermission(LocalUser u, String fileOrDirectory,
    FilesystemPermission permission);
