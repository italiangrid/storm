...
public interface LcmapsAccountInterface extends Library {
	...
	public static final LcmapsAccountInterface INSTANCE = (LcmapsAccountInterface) Native
		.loadLibrary(
	...
	/**
	 * Original signature :
	 * <code>int lcmaps_account_info_init(lcmaps_account_info_t*)</code><br>
	...
	/**
	 * Original signature :
	 * <code>int lcmaps_account_info_clean(lcmaps_account_info_t*)</code><br>
