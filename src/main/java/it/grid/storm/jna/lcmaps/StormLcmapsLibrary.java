...
public interface StormLcmapsLibrary extends Library {
  ...
  public static final String JNA_LIBRARY_NAME = "/usr/lib64/libstorm_lcmaps.so";
   ...
   */
  int map_user(String logfile, String user_dn, String[] fqan_list, int nfqan, IntBuffer uid,
      IntBuffer gid);

  public enum Errors {
    INIT_FAILURE(1, "lcmaps initialization failed"), ACCOUNT_INITIALIZATION_FAILURE(2,
        "lcmaps_account object creation failed"), RETURN_ACCOUNT_FAILED(3,
            "lcmaps_return_account_without_gsi call failed"), NO_GIDS_RETURNED(4,
                "no gids provided by the lcmaps_return_account_without_gsi call"), UNREACHIBLE_CODE(
                    5, "unexpected condition, this code should be nor reachable"), UNKNOW_ERROR(-1,
                        "error unknown");
