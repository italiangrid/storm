...
public interface LcmapsPoolindexInterface extends Library {
   ...
   * int lcmaps_return_account_without_gsi(char*, char**, int, int, lcmaps_account_info_t*)</code>
   * <br>
   * <i>native declaration : line 30</i><br>
   *
   * @deprecated use the safer methods {@link
   *     #lcmaps_return_account_without_gsi(java.nio.ByteBuffer, com.sun.jna.ptr.PointerByReference,
   *     int, int, test.lcmaps_account_info_t)} and {@link
   *     #lcmaps_return_account_without_gsi(com.sun.jna.Pointer, com.sun.jna.ptr.PointerByReference,
   *     int, int, test.lcmaps_account_info_t)} instead
   */
  @java.lang.Deprecated
  int lcmaps_return_account_without_gsi(
      Pointer user_dn,
      PointerByReference fqan_list,
      int nfqan,
      int mapcounter,
