...
public class HTTPPluginManager {
	 ...
	 */
	public static HTTPSPluginInterface getHTTPSPluginInstance()
		throws IllegalStateException {
		...
		synchronized (lock) {
			...
			if (!initialized) {
				log
					.warn("Unexpected state of not initialized HTTPPluginManager after signal barrier");
				throw new IllegalStateException(
					"Not initialized! Call init(HTTPSPluginFactory) first!");
			}
		}
