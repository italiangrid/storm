...
public class TreeNode {
	...
	// Sum of sizes of all files in term of BLOCK sizes under the tree with this node as root.
	...
	/**
	 * @param nrChildren the nrChildren to set
	 */
	...
	/**
	 * @param totApparentSize the totApparentSize to set
	 */
	...
	/**
	 * @param toCompute the toCompute to set
	 */
	...
	/**
	 * @param toComputeTime the toComputeTime to set
	 */
	...
	/**
	 * @param nodeUpdateTime the nodeUpdateTime to set
	 */
