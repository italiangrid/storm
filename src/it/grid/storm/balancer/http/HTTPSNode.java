...
public class HTTPSNode extends AbstractNode
{
    ...
    {
        return HTTPPluginManager.getHTTPSPluginInstance().getServiceStatus(hostname, port, HTTPSPluginInterface.Protocol.HTTPS) == HTTPSPluginInterface.ServiceStatus.RUNNING;
    }
