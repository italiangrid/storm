...
public interface StormLcmapsLibrary extends Library
{
    ...
    public static final StormLcmapsLibrary INSTANCE = (StormLcmapsLibrary) Native.loadLibrary(StormLcmapsLibrary.JNA_LIBRARY_NAME,
     ...
     */
    int map_user(String logfile, String user_dn, String[] fqan_list, int nfqan, IntBuffer uid, IntBuffer gid);
