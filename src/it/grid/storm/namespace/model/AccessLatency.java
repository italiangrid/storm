...
public class AccessLatency {
 ...
 public final static AccessLatency ONLINE = new AccessLatency("ONLINE", "online");
 public final static AccessLatency NEARLINE = new AccessLatency("NEARLINE", "nearline");
 public final static AccessLatency OFFLINE = new AccessLatency("OFFLINE", "offline");
 public final static AccessLatency UNKNOWN = new AccessLatency("UNKNOWN", "Access Latency UNKNOWN!");
