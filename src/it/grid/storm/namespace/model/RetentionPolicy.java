...
public class RetentionPolicy {
 ...
 public final static RetentionPolicy CUSTODIAL = new RetentionPolicy("CUSTODIAL", "custodial");
 public final static RetentionPolicy OUTPUT = new RetentionPolicy("OUTPUT", "output");
 public final static RetentionPolicy REPLICA = new RetentionPolicy("REPLICA", "replica");
 public final static RetentionPolicy UNKNOWN = new RetentionPolicy("UNKNOWN", "Retention policy UNKNOWN!");
 ...
 public static RetentionPolicy getRetentionPolicy(String retentionPolicy) {
   if (retentionPolicy.equals(RetentionPolicy.CUSTODIAL.toString()))return RetentionPolicy.CUSTODIAL;
