 ...
 * in the StoRM backend reads from configuration files, databases, etc.
 *
 * Implements a 'get<something>' method for each value that should be
 * looked up this way.  In fact, this is a "read-only" class.
 *
 ...
 * white spaces in-between; the name of the property in the configuration medium,
...
public class Configuration {
  ...
  //  public static final String RCSID = "$Id: Configuration.java,v 1.96 2007/05/11 13:41:34 ecorso Exp $";
    ...
    public String getDBURL() {
        String prefix = ""; String key1 = "asynch.picker.db.protocol";
        String host = "";   String key2 = "asynch.picker.db.host";
        String name = "";   String key3 = "asynch.picker.db.name";
        //get prefix...
     ...
     * configuration medium, then the default value is returned instead.
     *
     * Default value = "storm"; key searched in medium = "asynch.picker.db.username".
     */
     ...
     * configuration medium, then the default value is returned instead.
     *
     * Deafult value = "storm"; key searched in medium = "asynch.picker.db.passwd".
     */
     ...
     * after such period the DB connection will be closed and re-opened. Beware that
     * after such time expires, the connection is _not_ automatically closed and
     * reopened; rather, it acts as a flag that is considered by the main code and when
     * the most appropriate time comes, the connection is closed and reopened.
     *
     * This is because of MySQL bug that does not allow a connection to remain open
     * for an arbitrary amount of time! Else an Unexpected EOF Exception gets thrown
     * by the JDBC driver!
     *
    ...
    /**
     * Method used by PinnedFilesCatalog to get the initial delay in
     * _seconds_ before starting the cleaning thread.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by PinnedFilesCatalog to get the cleaning
     * time interval, in _seconds_.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
     ...
     * allowed, when a jit is being added/updated, but the user specified
     * a lower one. This method is also used by the PinLifetimeConverter to
    ...
    /**
     * Method used by PtPChunkCatalog to get the initial delay in
     * _seconds_ before starting the transiting thread.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by PtPChunkCatalog to get the transiting
     * time interval, in _seconds_.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
    ...
    /**
     * Method used by AdvancedPicker to get the initial delay before starting
     * to pick data from the DB, in _seconds_.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by RequestSummaryDAO to establish the maximum number of requests
     * to retrieve with each polling.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by CopyChunk when making a remote srmPrepareToPut (Push Mode). It needs it
     * to estalish the totalRetryTime in seconds to supply to the internal SRMClient. The
     * parameter is passed to the prepareToPut functionality.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by CopyChunk when making a remote srmPrepareToPut (Push Mode). The CopyChunk will
     * periodically invoke the statusOfPutRequest functionality of the internal SRMClient, for at most
     * the time out interval in seconds returned by this method.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by CopyChunk when making a remote srmPrepareToPut (Push Mode). The CopyChunk will
     * wait the amount of time in seconds returned by this method, before invoking again the
     * statusOfPutRequest functionality of the internal SRMClient. That is, it tells the polling
     * interval.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
    ...
    /**
     * Method used by CopyChunk when making the FileTransfer and finally invoking a remote srmPutDone.
     * The CopyChunk will wait the amount of time in seconds returned by this method, before invoking
     * again the srmPutDone functionality of the internal SRMClient. That is, it tells the time interval
     * between successive invocations: they are necessary when the returned status is SRM_INTERNAL_ERROR
     * which denotes a transient error situation.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by CopyChunk when making the FileTransfer and finally invoking a remote srmPutDone.
     * The CopyChunk may have to periodically invoke srmPutDone functionality of the internal SRMClient if
     * the web service returns SRM_INTERNAL_ERROR; in that case invocations will be attempted for at most
     * the time out interval in seconds returned by this method.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     ...
     * The String returned specifies the name of the class to instantiate; for now, there are two classes:
     * NaiveGridFTPTransferClient and StubGridFTPTransferClient.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
     * key="asynch.gridftpclient"; default value="it.grid.storm.asynch.NaiveGridFTPTransferClient";
     */
    ...
    /**
     * Method used by Factory invoked in CopyChunk subclasses, to instantiate an SRMClient.
     * The String returned specifies the name of the class to instantiate; for now, there are two classes:
     * NaiveSRMClient and StubSRMClient.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
     ...
     * StoRM instance! Used in srmCopy to understand if the fromSURL/toSURL refer to the server
     * itself or to some other foreign server! The List contains Strings in _lower_case_!!!
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used to get a List of Strings of the IPs of the machine hosting the FE for _this_
     * StoRM instance! Used in the xmlrcp server configuration, to allow request coming from
     * the specified IP. (Into the xmlrpc server the filter is done by IP, not hostname.)
     * This paramter is mandatory when a distribuited FE-BE installation of StoRM is used togheter
     * with a dynamic DNS on the FE hostname. In that case the properties  storm.machinenames is not
     * enough meaningfull.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
    ...
    /**
     * Reads the 'authorization.sources' configuration key and tries
     * to instanciate a <code>List</code> of classes whose name
     * matches the configuration key given.
     *
     * <p> The configuration value is a comma-separated list of class
     * names; therefore, they are case-sensitive.  If a name contains
     * no dots, then it is considered the name of a class in the
     * <code>it.grid.storm.authorization.sources</code> package.
     *
     * If no value is found in the configuration medium, then the
     * default value "DenyAllAuthorizationSource" is returned instead.
     *
     * FIXME: there should be no default value; failing to configure
     * an authorization source should be a critical error instead.
     *
     * @throws  RuntimeException if the extracted configuration
     * value cannot be mapped to a Java class, as we cannot properly
     * handle this condition. The use of a RuntimeException was
     * chosen after suggestions in
     * http://www-106.ibm.com/developerworks/library/j-jtp05254.html?ca=drs-j2204
     *
     * key="authorization.sources"; default value=DenyAllAuthorizationSource;
     *
     */
    ...
    /**
     * Reads the 'authorization.combining.algorithm' configuration key
     * and tries to instanciate a
     * <code>DecisionCombiningAlgorithm</code> whose name matches the
     * configuration key given.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
     * @throws IllegalArgumentException if the extracted configuration
     * value cannot be mapped to a subclass of {@link
     * it.grid.storm.authorization.DecisionCombiningAlgorithm}, as we
     * cannot properly handle this condition.  The use of a
     * RuntimeExcpetion was chosen after suggestions in
     * http://www-106.ibm.com/developerworks/library/j-jtp05254.html?ca=drs-j2204
     *
     * key="authorization.combining.algorithm"; default value=FirstProper;
     *
     */
    ...
    /**
     * Method that returns the directory holding the configuration file. The methods
     * that make use of it are uncertain... must be found soon!!!
     *
     * Beware that the configuration directory is implicit in the complete pathname
     * to the configuration file supplied in the command line when starting StoRM BE.
     */
    public String getConfigurationDir() {
        return cr.configurationDirectory();
        /*
        String key = "storm.configuration.dir";
        String dirValue = "";
        if (!cr.getConfiguration().containsKey(key)) {
            //default
            dirValue = "/home/storm/config";
        } else {
            //load from external source
            dirValue = cr.getConfiguration().getString(key);
        }
        //
        String  config = dirValue;
    ...
    /**
     * Method used by Space Reservation component to get the complete pathname for the
     * "namespace.xml" configuration File. This configuration file contains
     * information about the mapping between user, vo, storage area, default
     * lifetime and filetype. This method searches the configuration medium for
     * the configuration directory, and if it does not find it then a default value
     * for such directory is used. The returned String is of the form:
     *
     ...
     * file creation: StoRM crates a temporary file to manage GPFS ACL, and these
     * files are created in the temporary directory specified here.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in experimental persistence layer implementation to get DATASOURCE
     * type to use in DataSourceFactory. DataSource in test model must be MemoryObect,
     * while soon it will become a HYBERNATE object.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by StoRMCommandServer to establish the listening
     * port to which it should bind.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by Dispatcher and Feeder objects to check if a
     * serial scheduler must be used, or not.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in Persistence Component
     * It returns the DB vendor name.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in Persistence Component: it returns the host where the DB resides.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in Persistence Component
     * it returns the name of the DB to use.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in Persistence Component
     * it returns the name of the DB user that must be used.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in Persistence Component
     * it returns the password for the DB user that must be used.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in Persistence Component
     * it returns a boolean indicating whether to use connection pooling or not.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in Persistence Component
     * it returns an int indicating the maximum number of active connections in the
     * connection pool. It is the maximum number of active connections that can be
     * allocated from this pool at the same time... 0 (zero) for no limit.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used in Persistence Component
     * it returns an int indicating the maximum waiting time in _milliseconds_ for the
     * connection in the pool. It represents the time that the pool will wait
     * (when there are no available connections) for a connection to be returned
     * before throwing an exception... a value of -1 to wait indefinitely.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by the Synch Component to set the binding port for the _unsecure_
     * xmlrpc server in the BE.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    /**
     * Method used by the Synch Component to set the binding port for the _secure_
     * xmlrpc server in the BE.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     ...
     * the srmPrepareToPut management.
     *
    ...
    /**
     * Method used by the Scheduler Component to get the Queue Size for
     * the srmPrepareToPut management.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
     * Scheduler hold a blocking priority queue used to transfer and hols submitted tasks.
     *
     * The use of this queue interacts with pool sizing:
     *   - If fewer than corePoolSize threads are running, the Scheduler always
     *     prefers adding a new thread rather than queuing.
     *   - If corePoolSize or more threads are running, the Scheduler always
     ...
     *     exceed maxPoolSize, in which case, the task will be rejected.
     *
     * QueueSize - The initial capacity for this priority queue used for holding tasks before they are executed.
     *
     * The queue will hold only the Runnable tasks submitted by the execute method.
     *
     *
     ...
     * the srmPrepareToGet management.
     *
     * If no value is found in the configuration medium, then the default value
     * is returned instead.
     *
    ...
    *   corePoolSize - the number of threads to keep in the pool, even if they are idle.
     ...
     * @return boolean
     *
     * Method used by Namespace Configuration Reloading Strategy (Peeper). If "peeper" found
     * namespace.xml config file changed it checks if it can perform an automatic reload.
     *
    ...
    /**
     * Method used by the ECARAuthorizationSource to establish which ECAR end point
     * to use.
     *
     * If no value is found in the configuration medium, then the default one is
     * used instead.
   ...
   public int getServicePort() {
     ...
     * for considering a request expired.
     *
     ...
     * used instead.
     *
     * key="expired.request.time"; default value=7 (days - which correspond to
     * 7 * 24 * 60 * 60 seconds)
     */
     ...
     * starting the purging thread, in _seconds_.
     *
     * If no value is found in the configuration medium, then the default one is
     * used instead.
     *
     ...
     * requests should be enabled or not.
     *
     * If no value is found in the configuration medium, then the default one is
     * used instead.
     *
    ...
    /**
     * Method used by TURLBuilder to adding (in case) extra slashes after the "authority"
     * part of a TURL
     *
     * If no value is found in the configuration medium, then the default one is
     * used instead.
     *
     * key="extraslashes.file";
     * default value="" (that is 'file:///)
     * value = "/" ==> file:////
     */
     ...
     * used instead.
     *
     * key="extraslashes.rfio";
     * default value="" (that is 'rfio://<hostname>:port<PhysicalFN>'))
     ...
     * used instead.
     *
     * key="extraslashes.gsiftp";
     * default value="" (that is 'gsiftp://<hostname>:port<PhysicalFN>'))
     ...
     * used instead.
     *
     * key="extraslashes.root";
     * default value="/" (that is 'root://<hostname>:port<PhysicalFN>'))
