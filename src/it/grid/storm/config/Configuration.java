...
//        String key = "storm.service.SURL.endpoint";
    ...
    {
        if (!cr.getConfiguration().containsKey(SERVER_POOL_STATUS_CHECK_TIMEOUT_KEY)) {
            // return default
            return new Long(20000); //20 seconds
        } else {
            // load from external source
            return new Long(cr.getConfiguration().getLong(SERVER_POOL_STATUS_CHECK_TIMEOUT_KEY));
        }
    }
