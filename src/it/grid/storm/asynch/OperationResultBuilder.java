    ...
    public static Result build(Copy copy, List<Object> arguments, ResultType type)
    {
        switch (type)
        {
            case GET:
                ...
                if (arguments.get(1) != null && !(arguments.get(1) instanceof TReturnStatus))
                {
                    throw new IllegalArgumentException(
                ...
                if (arguments.get(3) != null && !(arguments.get(3) instanceof TSizeInBytes))
                {
                    throw new IllegalArgumentException(
                ...
                return copy.new GetOperationResult((TReturnStatus) arguments.get(1),
                                                   (TTURL) arguments.get(2),
                                                   (TSizeInBytes) arguments.get(3),
            ...
            case PUT:
                ...
                if (arguments.get(3) != null && !(arguments.get(3) instanceof TRequestToken))
                {
                    throw new IllegalArgumentException(
            ...
            default:
                throw new IllegalArgumentException("Unable to create a Result, unknown Copy.ResultType \'"
                        + type + "\'");
        }
    }
