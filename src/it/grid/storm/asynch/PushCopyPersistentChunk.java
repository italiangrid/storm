 ...
 * @version 2.0
 */
public class PushCopyPersistentChunk extends CopyPersistentChunk implements VisitableCopy{

    public PushCopyPersistentChunk(GridUserInterface gu, RequestSummaryData rsd, CopyPersistentChunkData requestData,
            int n, GlobalStatusManager gsm) throws InvalidCopyAttributesException,
        InvalidCopyPersistentChunkAttributesException
    {
        super(gu, rsd, requestData, n, gsm);
    }

    private static Logger log = LoggerFactory.getLogger(PushCopyPersistentChunk.class);
