...
public class BoLPersistentChunk extends BoL implements PersistentRequestChunk {
     ...
     */
    public BoLPersistentChunk(GridUserInterface gu, RequestSummaryData rsd, BoLPersistentChunkData chunkData,
            GlobalStatusManager gsm) throws InvalidRequestAttributesException,
    ...
    public String getName() {
        return "BoLChunk of request " + rsd.requestToken() + " for SURL " + requestData.getSURL();
    }
