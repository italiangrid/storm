...
public class FileAuthzDBWatcher {
    ...
    public enum AuthzDBFileStatus {
        ...
        AuthzDBFileStatus(String msg) { this.msg = msg; }
    ...
    public FileAuthzDBWatcher(long period, String authzDBPath) throws AuthzDBReaderException {
        ...
        log.debug("Found "+authzDBs.length+" authzDBs in '"+authzDBPath+"' path.");
        ...
        public void run() {
            ...
            for (String authzDB : authzDBs) {
                if (!(authzDBfiles.containsKey(authzDB))) {
                    ...
                    log.debug("Found a new authz files ('"+authzDB+"')in authzDB path.");
                }
            }
