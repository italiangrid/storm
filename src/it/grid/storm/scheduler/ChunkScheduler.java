...
public class ChunkScheduler implements Scheduler, Streets {
    ...
    private ChunkScheduler()
    {
        ...
        ptg_workers = new WorkerPool(ptg_workerCorePoolSize, ptg_workerMaxPoolSize, ptg_queueSize);
        ...
        ptp_workers = new WorkerPool(ptp_workerCorePoolSize, ptp_workerMaxPoolSize, ptp_queueSize);
        ...
        copy_workers = new WorkerPool(copy_workerCorePoolSize, copy_workerMaxPoolSize, copy_queueSize);
        ...
        bol_workers = new WorkerPool(bol_workerCorePoolSize, bol_workerMaxPoolSize, bol_queueSize);
    ...
    public SchedulerStatus getStatus(int type)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            schedStatus[2].setCompletedTaskCount(copy_workers.getCompletedTaskCount());
