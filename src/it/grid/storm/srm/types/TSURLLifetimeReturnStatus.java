/**
 * This class represents the TSURLLifetimeReturnStatus data associated with the SRM request.
...
public class TSURLLifetimeReturnStatus
{
    ...
    public TSURLLifetimeReturnStatus(TSURL surl, TReturnStatus status, TLifeTimeInSeconds fileLifetime,
            TLifeTimeInSeconds pinLifetime) throws InvalidTSURLLifetimeReturnStatusAttributeException {
    ...
    /**
     * Add an element to 'outputVector'. The element is a Hashtable structure of this instance
     * of TSURLLifetimeReturnStatus (used to comunicate with the FE).
     * @param outputVector Vector
     */
    public void encode(List outputVector)
    {
        ...
        if (this.fileLifetime != null)
            this.fileLifetime.encode(surlRetStatusParam, TLifeTimeInSeconds.PNAME_FILELIFETIME);
        if (this.pinLifetime != null)
            this.pinLifetime.encode(surlRetStatusParam, TLifeTimeInSeconds.PNAME_PINLIFETIME);
