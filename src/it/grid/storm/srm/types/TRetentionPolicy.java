...
public class TRetentionPolicy {
    ...
    public static final TRetentionPolicy 
        REPLICA = new TRetentionPolicy("REPLICA"),
    ...
    public final static TRetentionPolicy getTRetentionPolicy(int idx) {
        switch (idx) {
        case 0: return REPLICA;
        case 1: return OUTPUT;
        case 2: return CUSTODIAL;
    ...
    public void encode(Map outputParam, String fieldName) {
        ...
        if (this.equals(TRetentionPolicy.REPLICA)) value = new Integer(0);
        if (this.equals(TRetentionPolicy.OUTPUT)) value = new Integer(1);
        if (this.equals(TRetentionPolicy.CUSTODIAL)) value = new Integer(2);
