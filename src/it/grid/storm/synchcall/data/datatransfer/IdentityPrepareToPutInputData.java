...
public class IdentityPrepareToPutInputData extends AnonymousPrepareToPutInputData implements IdentityInputData
{
    private final GridUserInterface auth;

    public IdentityPrepareToPutInputData(GridUserInterface auth, TSURL surl, TURLPrefix transferProtocols)
