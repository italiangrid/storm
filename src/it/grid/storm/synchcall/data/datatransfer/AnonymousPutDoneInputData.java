...
public class AnonymousPutDoneInputData extends AnonymousInputData
{
    ...
    public AnonymousPutDoneInputData(TRequestToken reqToken, ArrayOfSURLs surlArray) throws IllegalArgumentException
    {
        if (surlArray == null || reqToken == null)
        {
            throw new IllegalArgumentException("Unable to create the object, invalid arguments: reqToken="
                    + reqToken + " surlArray=" + surlArray);
        }
