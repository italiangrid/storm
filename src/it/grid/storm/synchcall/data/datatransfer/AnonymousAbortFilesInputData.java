...
public class AnonymousAbortFilesInputData extends AnonymousAbortGeneralInputData implements AbortFilesInputData
{
        ...
        throws IllegalArgumentException
    {
        ...
        if (surlArray == null)
        {
            throw new IllegalArgumentException("Unable to create the object, invalid arguments: surlArray="
                    + surlArray);
        }
    ...
    /*
     * (non-Javadoc)
     * @see it.grid.storm.synchcall.data.datatransfer.AbortFilesInputData#getArrayOfSURLs()
     */
    @Override
