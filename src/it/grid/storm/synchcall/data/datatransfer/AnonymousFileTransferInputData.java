...
public class AnonymousFileTransferInputData extends AbstractInputData implements FileTransferInputData
{
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.datatransfer.FileTransferInputData#getSurl()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.datatransfer.FileTransferInputData#getTransferProtocols()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.datatransfer.FileTransferInputData#getTargetSpaceToken()
     */
    @Override
