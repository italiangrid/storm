...
public class AnonymousGetSpaceTokensInputData extends AbstractInputData implements GetSpaceTokensInputData
{
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.space.GetSpaceTokensInputData#getSpaceTokenAlias()
     */
    @Override
