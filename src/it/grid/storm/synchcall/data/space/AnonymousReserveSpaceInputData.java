...
public class AnonymousReserveSpaceInputData extends AbstractInputData implements ReserveSpaceInputData
{
    ...
    public AnonymousReserveSpaceInputData(String spaceTokenAlias, TRetentionPolicyInfo retentionPolicyInfo,
            TSizeInBytes spaceDesired, TSizeInBytes spaceGuaranteed, 
            ArrayOfTExtraInfo storageSystemInfo) throws IllegalArgumentException
    {
        if (spaceTokenAlias == null)
        {
            throw new IllegalArgumentException("Unable to create the object, invalid arguments: spaceTokenAlias="
                    + spaceTokenAlias);
        }
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.space.ReserveSpaceInputData#getSpaceTokenAlias()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.space.ReserveSpaceInputData#getRetentionPolicyInfo()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.space.ReserveSpaceInputData#getSpaceDesired()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.space.ReserveSpaceInputData#getSpaceGuaranteed()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.space.ReserveSpaceInputData#getSpaceLifetime()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.synchcall.data.space.ReserveSpaceInputData#getStorageSystemInfo()
     */
    @Override
