...
public class PrepareToPutRequestCommand implements Command
{
    ...
    public OutputData execute(InputData inputData) throws IllegalArgumentException, CommandException
    {
        ...
        {
            log.error("Unable to convert from InputData. Wrong InputData type: \'" + inputData.getClass().getName() + "\'");
            throw new IllegalArgumentException("Unable to convert from InputData. Wrong InputData type: \'" + inputData.getClass().getName() + "\'");
        }
        PtP request;
        try
        {
        ...
        {
            log.error("Unable to build PtP request from the InputData. BuilderException: " + e.getMessage());
