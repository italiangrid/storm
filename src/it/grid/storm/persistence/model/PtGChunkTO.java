 ...
 * PrepareToGet srm request. It contains data about: the requestToken, the fromSURL and
 * the storageSystemInfo for that SURL, the requested lifeTime of pinning, the
 * requested fileStorageType and any available spaceToken, the TDirOption which explains
 * whether the requested SURL is a directory and if it must be recursed at all levels, as
 * well as the desired number of levels to recurse, the desired transferProtocols in order
 * of preference, the fileSize, the estimatedTimeOnQueue, the estimatedProcessingTime, the
 * transferURL for the supplied SURL, and the remainingPinTime.
 *
...
public class PtGChunkTO {
    ...
    private TStorageSystemInfo storageSystemInfo; //TStorageSystemInfo associated to fromSURL: it may be useless in StoRM!

    private TLifeTimeInSeconds lifeTime;      //requested lifetime for fromSURL - BEWARE!!! It is the pin time!!!
    private TFileStorageType fileStorageType; //TFileStorageType requested for specific fromSURL to get
    ...
    private TLifeTimeInSeconds estimatedWaitTimeOnQueue;  //estimated time this chunk will remain in queue
    private TLifeTimeInSeconds estimatedProcessingTime;   //estimated time this chunk will take to be processed
    private TTURL transferURL;                   //TURL for picking up the requested file
    private TLifeTimeInSeconds remainingPinTime; //estimated time remaining for Pin validity



    public PtGChunkTO(TRequestToken requestToken,
        TSURL fromSURL, TStorageSystemInfo storageSystemInfo,
        TLifeTimeInSeconds lifeTime, TFileStorageType fileStorageType, TSpaceToken spaceToken, TDirOption dirOption,
        TURLPrefix transferProtocols,
        TSizeInBytes fileSize, TReturnStatus status, TLifeTimeInSeconds estimatedWaitTimeOnQueue, TLifeTimeInSeconds estimatedProcessingTime, TTURL transferURL, TLifeTimeInSeconds remainingPinTime)
        ...
        boolean ok = requestToken!=null &&
            ...
            fileSize!=null &&
            status!=null &&
            estimatedWaitTimeOnQueue!=null &&
            estimatedProcessingTime!=null &&
            transferURL!=null &&
            remainingPinTime!=null;

        if (!ok) throw new InvalidPtGChunkDataAttributesException(requestToken,fromSURL,storageSystemInfo,lifeTime,fileStorageType,
            spaceToken,dirOption,transferProtocols,fileSize,status,estimatedWaitTimeOnQueue,estimatedProcessingTime,
    ...
    /**
     * Method that returns the storageSystemInfo of the srm request to which this chunk belongs
     */
    public TStorageSystemInfo storageSystemInfo() {return storageSystemInfo;}
    ...
    /**
     * Method that returns the filerequested pin life time for this chunk of the srm request.
     */
     ...
     */
    public TDirOption dirOption() {return dirOption;}
     ...
     */
    public TSizeInBytes fileSize() {return fileSize;}

    /**
     * Method that returns the estimated time in queue for this chunk of the srm request.
     */
    public TLifeTimeInSeconds estimatedWaitTimeOnQueue() {return estimatedWaitTimeOnQueue;}

    /**
     * Method that returns the estimated processing time for this chunk of the srm request.
     */
    public TLifeTimeInSeconds estimatedProcessingTime() {return estimatedProcessingTime;}
    ...
    /**
     * Method that returns the estimated remaining pin time for this chunk of the srm request.
     */
    public TLifeTimeInSeconds remainingPinTime() {return remainingPinTime;}
    ...
    /**
     * Method that sets the status of this request to SRM_DONE;
     * it needs the explanation String which describes the situation in greater detail;
     * if a null is passed, then an empty String is used as explanation.
     */
    ...
    public String toString() {
        ...
        sb.append("storageSystemInfo="); sb.append(storageSystemInfo); sb.append("; ");
        ...
        sb.append("estimatedWaitTimeOnQueue="); sb.append(estimatedWaitTimeOnQueue); sb.append("; ");
        sb.append("estimatedProcessingTime="); sb.append(estimatedProcessingTime); sb.append("; ");
        sb.append("transferURL="); sb.append(transferURL); sb.append("; ");
        sb.append("remainingPinTime="); sb.append(remainingPinTime); sb.append(".");
        return sb.toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PtGChunkTO)) return false;
        PtGChunkTO cd = (PtGChunkTO) o;
        return requestToken.equals(cd.requestToken) &&
     ...
     * requested SURL. If the supplied TSizeInByte is null, the nothing
     * gets set!
     */
    ...
    /**
     * Method used to set the estimated time that the chunk will spend on the queue.
     * If the supplied TLifeTimeInSeconds is null, then nothing gets set!
     */
    public void setEstimatedWaitTimeOnQueue(final TLifeTimeInSeconds time) {
        if (time!=null) estimatedWaitTimeOnQueue = time;
    };
    ...
    public void setEstimatedProcessingTime(final TLifeTimeInSeconds time) {
        if (time!=null) estimatedProcessingTime = time;
    };
