...
public class GUID implements Serializable {
    ...
    //public static final long serialVersionUID = daomedge.abstractdao.VersionControl.serialVersionUID;
    ...
    /**
     * Sets the byte in the array to the bytes in a long value.
     * In reverse order(IE Least significant byte goes first)
     *
    ...
    /**
     * Creates a new GUID from nowhere.
     * Actually it uses the time, IPAddress and a random number.
    ...
    /**
     * Stores the 16 bytes seperately, this returns that array
     * Not sure why though.
     *
    ...
    /**
     * Overrides toString().
     * Returns the array of bytes in the standard form:
