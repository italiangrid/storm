...
public class FileSystemCheckerMtab extends FileSystemCheckerFromFile
{
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.filesystem.FileSystemCheckerFromFile#getMountPointIndex()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.filesystem.FileSystemCheckerFromFile#skipLine(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see it.grid.storm.filesystem.FileSystemCheckerFromFile#tokenizeLine(java.lang.String)
     */
    @Override
