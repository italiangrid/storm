 ...
 */
public class InvalidFileTransferDataAttributesException extends InvalidSurlRequestDataAttributesException
{
    ...
    public InvalidFileTransferDataAttributesException(TSURL SURL, 
            TURLPrefix transferProtocols, TReturnStatus status, TTURL transferURL, String message)
    {
    ...
    public InvalidFileTransferDataAttributesException(TSURL SURL, 
            TURLPrefix transferProtocols, TReturnStatus status, TTURL transferURL, Throwable cause)
    {
    ...
    public InvalidFileTransferDataAttributesException(TSURL SURL, 
            TURLPrefix transferProtocols, TReturnStatus status, TTURL transferURL, String message, Throwable cause)
    {
    ...
    public String toString()
    {
        ...
        builder.append("InvalidFileTransferDataAttributesException [nullTransferProtocols=");
