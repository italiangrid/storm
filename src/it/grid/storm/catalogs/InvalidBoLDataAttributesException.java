 ...
 *
 */
public class InvalidBoLDataAttributesException extends InvalidFileTransferDataAttributesException
{
    ...
    public InvalidBoLDataAttributesException(TSURL fromSURL, TLifeTimeInSeconds lifeTime,
