 ...
 * @version 2.0
 */
public class InvalidPtGPersistentChunkDataAttributesException extends InvalidPtGDataAttributesException
{
     ...
     * to be thrown.
     */
    public InvalidPtGPersistentChunkDataAttributesException(TRequestToken requestToken, TSURL fromSURL, TLifeTimeInSeconds lifeTime,
            TDirOption dirOption, TURLPrefix transferProtocols, TSizeInBytes fileSize, TReturnStatus status,
            TTURL transferURL)
    {
        super(fromSURL, lifeTime, dirOption, transferProtocols, fileSize, status, transferURL);
    ...
    public String toString()
    {
        ...
        builder.append("InvalidPtGPersistentChunkDataAttributesException [nullRequestToken=");
