...
public class IdentityPtPData extends AnonymousPtPData implements IdentityInputData
{
     ...
     */
    public IdentityPtPData(GridUserInterface auth, TSURL SURL, TLifeTimeInSeconds pinLifetime,
    ...
    {
        super(SURL, pinLifetime, fileLifetime, fileStorageType, spaceToken, expectedFileSize,
