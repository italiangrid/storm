...
public class CopyData extends SurlRequestData {
    ...
    /**
     * requested lifetime - BEWARE!!! It is the fileLifetime at destination in case of Volatile files! 
     */
    ...
    /**
     * specifies the behaviour in case of existing files for Put part of the copy (could be local or remote!)
     */
    protected TOverwriteMode overwriteOption; 

    public CopyData(TSURL fromSURL, TSURL destinationSURL, TLifeTimeInSeconds lifetime,
            TFileStorageType fileStorageType, TSpaceToken spaceToken, TOverwriteMode overwriteOption,
            TReturnStatus status) throws InvalidCopyDataAttributesException,
        InvalidSurlRequestDataAttributesException
    {
        super(fromSURL, status);
        if (destinationSURL == null || lifetime == null || fileStorageType == null || spaceToken == null
                || overwriteOption == null)
        {
            throw new InvalidCopyDataAttributesException(fromSURL, destinationSURL, lifetime,
                                                         fileStorageType, spaceToken, overwriteOption, status);
        }
