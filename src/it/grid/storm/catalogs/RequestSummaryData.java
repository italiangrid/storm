...
public class RequestSummaryData  {
    ...
    public boolean equals(Object obj)
    {
        ...
        if (deferredStartTime == null)
        {
            ...
            if (!deferredStartTime.equals(other.deferredStartTime))
            {
                return false;
            }
        if (errstring == null)
        {
            ...
            if (!errstring.equals(other.errstring))
            {
                return false;
            }
        if (fileLifetime == null)
        {
            ...
            if (!fileLifetime.equals(other.fileLifetime))
            {
                return false;
            }
        if (gu == null)
        ...
        if (nbreqfiles == null)
        {
            ...
            if (!nbreqfiles.equals(other.nbreqfiles))
            {
                return false;
            }
        if (numOfCompleted == null)
        {
            ...
            if (!numOfCompleted.equals(other.numOfCompleted))
            {
                return false;
            }
        if (numOfFailed == null)
        {
            ...
            if (!numOfFailed.equals(other.numOfFailed))
            {
                return false;
            }
        if (numOfWaiting == null)
        {
            ...
            if (!numOfWaiting.equals(other.numOfWaiting))
            {
                return false;
            }
        if (pinLifetime == null)
        ...
        if (remainingDeferredStartTime == null)
        {
            ...
            if (!remainingDeferredStartTime.equals(other.remainingDeferredStartTime))
            {
                return false;
            }
        if (remainingTotalTime == null)
        {
            ...
            if (!remainingTotalTime.equals(other.remainingTotalTime))
            {
                return false;
            }
        ...
        if (retrytime == null)
        {
            ...
            if (!retrytime.equals(other.retrytime))
            {
                return false;
            }
        if (spaceToken == null)
        {
            ...
            if (!spaceToken.equals(other.spaceToken))
            {
                return false;
            }
        if (status == null)
