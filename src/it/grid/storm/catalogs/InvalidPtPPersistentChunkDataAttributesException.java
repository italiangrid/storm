 ...
 * @version 2.0
 */
public class InvalidPtPPersistentChunkDataAttributesException extends InvalidPtPDataAttributesException
{
     ...
     * to be thrown.
     */
    public InvalidPtPPersistentChunkDataAttributesException(TRequestToken requestToken, TSURL toSURL,
            TLifeTimeInSeconds fileLifetime, TLifeTimeInSeconds pinLifetime,
            TFileStorageType fileStorageType, TSpaceToken spaceToken, TSizeInBytes knownSizeOfThisFile,
            TURLPrefix transferProtocols, TOverwriteMode overwriteOption, TReturnStatus status,
            TTURL transferURL)
    {
        super(toSURL, fileLifetime, pinLifetime, fileStorageType, spaceToken, knownSizeOfThisFile,
