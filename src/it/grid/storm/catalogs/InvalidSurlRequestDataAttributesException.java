...
public class InvalidSurlRequestDataAttributesException extends Exception
{
    ...
    public InvalidSurlRequestDataAttributesException(TSURL SURL, TReturnStatus status, String message)
    {
        super(message);
        init(SURL, status);
    }

    public InvalidSurlRequestDataAttributesException(TSURL SURL, TReturnStatus status, Throwable cause)
    {
        super(cause);
        init(SURL, status);
    }

    public InvalidSurlRequestDataAttributesException(TSURL SURL, TReturnStatus status, String message, Throwable cause)
    {
        super(message, cause);
        init(SURL, status);
    }
