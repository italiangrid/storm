 ...
 * @version 1.0
 */
public class GenericFS_MOCKImpl implements MOCK_GenericFS {

  public GenericFS_MOCKImpl(String mountpoint) throws it.grid.storm.filesystem.AclNotSupported, it.grid.storm.filesystem.FilesystemError {
}
