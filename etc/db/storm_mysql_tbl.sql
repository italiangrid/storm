...
ALTER TABLE request_Get add index FK_request_Ge_9630 (request_DirOptionID), add constraint FK_request_Ge_9630 foreign key (request_DirOptionID) references request_DirOption (ID) ON DELETE CASCADE;
...
ALTER TABLE request_Copy add index FK_request_Co_2630 (request_DirOptionID), add constraint FK_request_Co_2630 foreign key (request_DirOptionID) references request_DirOption (ID) ON DELETE CASCADE;
...
ALTER TABLE request_BoL add index FK_request_Bo_4166 (request_DirOptionID), add constraint FK_request_Bo_4166 foreign key (request_DirOptionID) references request_DirOption (ID) ON DELETE CASCADE;
