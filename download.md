...
### Official releases
Official releases are done in the contest of the EMI project.
...
We will provide a repository for testing versions, i.e versions for which the development has finished and can be passed to staged roll-out and whatever.
